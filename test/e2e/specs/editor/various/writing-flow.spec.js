...
test.describe( 'Writing Flow (@firefox, @webkit)', () => {
	...
	test( 'should navigate around nested inline boundaries', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph"><strong><em>1</em> <em>2</em></strong></p>
<!-- /wp:paragraph -->` );
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">a<strong>b<em>c1d</em>e f<em>g2h</em>i</strong>j</p>
<!-- /wp:paragraph -->` );
	} );
	...
	test( 'should insert line break at end', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">a<br></p>
<!-- /wp:paragraph -->` );
	} );
	...
	test( 'should insert line break at end and continue writing', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">a<br>b</p>
<!-- /wp:paragraph -->` );
	} );
...
<!-- /wp:paragraph -->` );
	...
	test( 'should insert line break at start', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph"><br>a</p>
<!-- /wp:paragraph -->` );
	} );
...
<!-- /wp:paragraph -->` );
	...
	test( 'should not delete surrounding space when deleting a word with Alt+Backspace', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">alpha  gamma</p>
<!-- /wp:paragraph -->` );
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">alpha beta gamma</p>
<!-- /wp:paragraph -->` );
	} );
...
<!-- /wp:paragraph -->` );
	...
	test( 'should merge and then soft line break', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">1<br>2</p>
<!-- /wp:paragraph -->` );
	} );
...
<!-- /wp:paragraph -->` );
	...
	test( 'should remember initial vertical position', async ( {
		...
		await expect.poll( editor.getEditedPostContent )
			.toBe( `<!-- wp:paragraph -->
<p class="wp-block-paragraph">1x</p>
<!-- /wp:paragraph -->

<!-- wp:paragraph -->
<p class="wp-block-paragraph"><br>2</p>
<!-- /wp:paragraph -->` );
	} );
