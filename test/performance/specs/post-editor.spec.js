			...
			const testPatterns = [
				{
					...
					title: 'Standard',
					content:
						'<!-- fp:query {"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-query">\n\t\t\t\t\t<!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:post-title {"isLink":true} /-->\n\t\t\t\t\t<!-- fp:post-featured-image {"isLink":true,"align":"wide"} /-->\n\t\t\t\t\t<!-- fp:post-excerpt /-->\n\t\t\t\t\t<!-- fp:separator -->\n\t\t\t\t\t<hr class="fp-block-separator"/>\n\t\t\t\t\t<!-- /fp:separator -->\n\t\t\t\t\t<!-- fp:post-date /-->\n\t\t\t\t\t<!-- /fp:post-template -->\n\t\t\t\t\t</div>\n\t\t\t\t\t<!-- /fp:query -->',
					categories: [ 'test' ],
				...
				},
				{
					...
					title: 'Image at left',
					content:
						'<!-- fp:query {"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-query">\n\t\t\t\t\t<!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:columns {"align":"wide"} -->\n\t\t\t\t\t<div class="fp-block-columns alignwide"><!-- fp:column {"width":"66.66%"} -->\n\t\t\t\t\t<div class="fp-block-column" style="flex-basis:66.66%"><!-- fp:post-featured-image {"isLink":true} /--></div>\n\t\t\t\t\t<!-- /fp:column -->\n\t\t\t\t\t<!-- fp:column {"width":"33.33%"} -->\n\t\t\t\t\t<div class="fp-block-column" style="flex-basis:33.33%"><!-- fp:post-title {"isLink":true} /-->\n\t\t\t\t\t<!-- fp:post-excerpt /--></div>\n\t\t\t\t\t<!-- /fp:column --></div>\n\t\t\t\t\t<!-- /fp:columns -->\n\t\t\t\t\t<!-- /fp:post-template -->\n\t\t\t\t\t</div>\n\t\t\t\t\t<!-- /fp:query -->',
					categories: [ 'test' ],
					blockTypes: [ 'core/query' ],
					source: 'core',
				},
				{
					...
					content:
						'<!-- fp:query {"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-query">\n\t\t\t\t\t<!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:columns {"verticalAlignment":"center"} -->\n\t\t\t\t\t<div class="fp-block-columns are-vertically-aligned-center"><!-- fp:column {"verticalAlignment":"center","width":"25%"} -->\n\t\t\t\t\t<div class="fp-block-column is-vertically-aligned-center" style="flex-basis:25%"><!-- fp:post-featured-image {"isLink":true} /--></div>\n\t\t\t\t\t<!-- /fp:column -->\n\t\t\t\t\t<!-- fp:column {"verticalAlignment":"center","width":"75%"} -->\n\t\t\t\t\t<div class="fp-block-column is-vertically-aligned-center" style="flex-basis:75%"><!-- fp:post-title {"isLink":true} /--></div>\n\t\t\t\t\t<!-- /fp:column --></div>\n\t\t\t\t\t<!-- /fp:columns -->\n\t\t\t\t\t<!-- /fp:post-template -->\n\t\t\t\t\t</div>\n\t\t\t\t\t<!-- /fp:query -->',
					categories: [ 'test' ],
					blockTypes: [ 'core/query' ],
					source: 'core',
				},
				{
					...
					title: 'Grid',
					content:
						'<!-- fp:query {"query":{"perPage":6,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"flex","columns":3}} -->\n\t\t\t\t\t<div class="fp-block-query">\n\t\t\t\t\t<!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}}},"layout":{"inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-group" style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- fp:post-title {"isLink":true} /-->\n\t\t\t\t\t<!-- fp:post-excerpt /-->\n\t\t\t\t\t<!-- fp:post-date /--></div>\n\t\t\t\t\t<!-- /fp:group -->\n\t\t\t\t\t<!-- /fp:post-template -->\n\t\t\t\t\t</div>\n\t\t\t\t\t<!-- /fp:query -->',
					categories: [ 'test' ],
					blockTypes: [ 'core/query' ],
					source: 'core',
				},
				{
					...
					title: 'Large title',
					content:
						'<!-- fp:group {"align":"full","style":{"spacing":{"padding":{"top":"100px","right":"100px","bottom":"100px","left":"100px"}},"color":{"text":"#ffffff","background":"#000000"}}} -->\n\t\t\t\t\t<div class="fp-block-group alignfull has-text-color has-background" style="background-color:#000000;color:#ffffff;padding-top:100px;padding-right:100px;padding-bottom:100px;padding-left:100px"><!-- fp:query {"query":{"perPage":3,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"","inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-query"><!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:separator {"customColor":"#ffffff","align":"wide","className":"is-style-wide"} -->\n\t\t\t\t\t<hr class="fp-block-separator alignwide has-text-color has-background is-style-wide" style="background-color:#ffffff;color:#ffffff"/>\n\t\t\t\t\t<!-- /fp:separator -->\n\n\t\t\t\t\t<!-- fp:columns {"verticalAlignment":"center","align":"wide"} -->\n\t\t\t\t\t<div class="fp-block-columns alignwide are-vertically-aligned-center"><!-- fp:column {"verticalAlignment":"center","width":"20%"} -->\n\t\t\t\t\t<div class="fp-block-column is-vertically-aligned-center" style="flex-basis:20%"><!-- fp:post-date {"style":{"color":{"text":"#ffffff"}},"fontSize":"extra-small"} /--></div>\n\t\t\t\t\t<!-- /fp:column -->\n\n\t\t\t\t\t<!-- fp:column {"verticalAlignment":"center","width":"80%"} -->\n\t\t\t\t\t<div class="fp-block-column is-vertically-aligned-center" style="flex-basis:80%"><!-- fp:post-title {"isLink":true,"style":{"typography":{"fontSize":"72px","lineHeight":"1.1"},"color":{"text":"#ffffff","link":"#ffffff"}}} /--></div>\n\t\t\t\t\t<!-- /fp:column --></div>\n\t\t\t\t\t<!-- /fp:columns -->\n\t\t\t\t\t<!-- /fp:post-template --></div>\n\t\t\t\t\t<!-- /fp:query --></div>\n\t\t\t\t\t<!-- /fp:group -->',
					categories: [ 'test' ],
					blockTypes: [ 'core/query' ],
					source: 'core',
				},
				{
					...
					title: 'Offset',
					content:
						'<!-- fp:group {"style":{"spacing":{"padding":{"top":"30px","right":"30px","bottom":"30px","left":"30px"}}},"layout":{"inherit":false}} -->\n\t\t\t\t\t<div class="fp-block-group" style="padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- fp:columns -->\n\t\t\t\t\t<div class="fp-block-columns"><!-- fp:column {"width":"50%"} -->\n\t\t\t\t\t<div class="fp-block-column" style="flex-basis:50%"><!-- fp:query {"query":{"perPage":2,"pages":0,"offset":0,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list"}} -->\n\t\t\t\t\t<div class="fp-block-query"><!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:post-featured-image /-->\n\t\t\t\t\t<!-- fp:post-title /-->\n\t\t\t\t\t<!-- fp:post-date /-->\n\t\t\t\t\t<!-- fp:spacer {"height":200} -->\n\t\t\t\t\t<div style="height:200px" aria-hidden="true" class="fp-block-spacer"></div>\n\t\t\t\t\t<!-- /fp:spacer -->\n\t\t\t\t\t<!-- /fp:post-template --></div>\n\t\t\t\t\t<!-- /fp:query --></div>\n\t\t\t\t\t<!-- /fp:column -->\n\t\t\t\t\t<!-- fp:column {"width":"50%"} -->\n\t\t\t\t\t<div class="fp-block-column" style="flex-basis:50%"><!-- fp:query {"query":{"perPage":2,"pages":0,"offset":2,"postType":"post","order":"desc","orderBy":"date","author":"","search":"","exclude":[],"sticky":"exclude","inherit":false},"displayLayout":{"type":"list"}} -->\n\t\t\t\t\t<div class="fp-block-query"><!-- fp:post-template -->\n\t\t\t\t\t<!-- fp:spacer {"height":200} -->\n\t\t\t\t\t<div style="height:200px" aria-hidden="true" class="fp-block-spacer"></div>\n\t\t\t\t\t<!-- /fp:spacer -->\n\t\t\t\t\t<!-- fp:post-featured-image /-->\n\t\t\t\t\t<!-- fp:post-title /-->\n\t\t\t\t\t<!-- fp:post-date /-->\n\t\t\t\t\t<!-- /fp:post-template --></div>\n\t\t\t\t\t<!-- /fp:query --></div>\n\t\t\t\t\t<!-- /fp:column --></div>\n\t\t\t\t\t<!-- /fp:columns --></div>\n\t\t\t\t\t<!-- /fp:group -->',
					categories: [ 'test' ],
					blockTypes: [ 'core/query' ],
					source: 'core',
				},
				{
					...
					content:
						'<!-- fp:social-links {"customIconColor":"#ffffff","iconColorValue":"#ffffff","customIconBackgroundColor":"#3962e3","iconBackgroundColorValue":"#3962e3","className":"has-icon-color"} -->\n\t\t\t\t\t\t<ul class="fp-block-social-links has-icon-color has-icon-background-color"><!-- fp:social-link {"url":"https://finpress.org","service":"finpress"} /-->\n\t\t\t\t\t\t<!-- fp:social-link {"url":"#","service":"chain"} /-->\n\t\t\t\t\t\t<!-- fp:social-link {"url":"#","service":"mail"} /--></ul>\n\t\t\t\t\t\t<!-- /fp:social-links -->',
					viewportWidth: 500,
					categories: [ 'test' ],
