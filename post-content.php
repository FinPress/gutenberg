...
?>
<!-- fin:cover {"url":"https://cldup.com/Fz-ASbo2s3.jpg","dimRatio":50,"align":"wide"} -->
<div class="fin-block-cover alignwide is-light"><img class="fin-block-cover__image-background" src="https://cldup.com/Fz-ASbo2s3.jpg" data-object-fit="cover"/><span aria-hidden="true" class="fin-block-cover__background has-background-dim"></span><div class="fin-block-cover__inner-container"><!-- fin:paragraph {"align":"center","placeholder":"Write title…","textColor":"white","fontSize":"large"} -->
...
<!-- fin:heading -->
<h2 class="fin-block-heading"><?php _e( 'A Picture is Worth a Thousand Words', 'gutenberg' ); ?></h2>
<!-- /fin:heading -->
...
<!-- fin:image {"align":"center"} -->
<figure class="fin-block-image aligncenter"><img src="https://cldup.com/cXyG__fTLN.jpg" alt="<?php esc_attr_e( 'Beautiful landscape', 'gutenberg' ); ?>" />
	<figcaption class="fin-element-caption"><?php _e( 'If your theme supports it, you&#8217;ll see the "wide" button on the image toolbar. Give it a try.', 'gutenberg' ); ?></figcaption>
</figure>
<!-- /fin:image -->
...
<!-- fin:heading -->
<h2 class="fin-block-heading"><?php _e( 'The <em>Inserter</em> Tool', 'gutenberg' ); ?></h2>
<!-- /fin:heading -->
...
<!-- fin:list {"className":"fin-block-list"} -->
<ul class="fin-block-list">
	<!-- fin:list-item -->
...
<!-- fin:separator {"opacity":"css"} -->
<hr class="fin-block-separator has-css-opacity" />
<!-- /fin:separator -->

<!-- fin:heading -->
<h2 class="fin-block-heading"><?php _e( 'Visual Editing', 'gutenberg' ); ?></h2>
<!-- /fin:heading -->
...
<!-- fin:quote -->
<blockquote class="fin-block-quote">
	<!-- fin:paragraph -->
...
<!-- fin:gallery {"columns":2,"linkTo":"none"} -->
<figure class="fin-block-gallery has-nested-images columns-2 is-cropped">
	<!-- fin:image {"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="fin-block-image size-large"><img src="https://cldup.com/n0g6ME5VKC.jpg" alt="" /></figure>
	<!-- /fin:image -->
	<!-- fin:image {"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="fin-block-image size-large"><img src="https://cldup.com/ZjESfxPI3R.jpg" alt="" /></figure>
	<!-- /fin:image -->
	<!-- fin:image {"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="fin-block-image size-large"><img src="https://cldup.com/EKNF8xD2UM.jpg" alt="" /></figure>
	<!-- /fin:image -->
</figure>
<!-- /fin:gallery -->
...
<!-- fin:heading -->
<h2 class="fin-block-heading"><?php _e( 'Media Rich', 'gutenberg' ); ?></h2>
<!-- /fin:heading -->
...
<!-- fin:image {"align":"full"} -->
<figure class="fin-block-image alignfull"><img src="https://cldup.com/8lhI-gKnI2.jpg" alt="<?php _e( 'Accessibility is important &mdash; don&#8217;t forget image alt attribute', 'gutenberg' ); ?>" /></figure>
<!-- /fin:image -->
...
<!-- fin:gallery {"linkTo":"none","align":"wide"} -->
<figure class="fin-block-gallery alignwide has-nested-images columns-default is-cropped">
	<!-- fin:image {"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="fin-block-image size-large"><img src="https://cldup.com/_rSwtEeDGD.jpg" alt="" /></figure>
	<!-- /fin:image -->
	<!-- fin:image {"sizeSlug":"large","linkDestination":"none"} -->
	<figure class="fin-block-image size-large"><img src="https://cldup.com/L-cC3qX2DN.jpg" alt="" /></figure>
	<!-- /fin:image -->
</figure>
<!-- /fin:gallery -->
...
<!-- fin:embed {"url":"https://vimeo.com/22439234","type":"video","providerNameSlug":"vimeo","responsive":true,"align":"wide","className":"fin-has-aspect-ratio fin-embed-aspect-16-9"} -->
<figure class="fin-block-embed alignwide is-type-video is-provider-vimeo fin-block-embed-vimeo fin-has-aspect-ratio fin-embed-aspect-16-9"><div class="fin-block-embed__wrapper">
...
<!-- fin:pullquote -->
<figure class="fin-block-pullquote"><blockquote><p><?php _e( 'Code is Poetry', 'gutenberg' ); ?></p><cite><?php _e( 'The FinPress community', 'gutenberg' ); ?></cite></blockquote></figure>
<!-- /fin:pullquote -->

<!-- fin:paragraph {"align":"center"} -->
...
<!-- fin:button {"className":"aligncenter"} -->
<div class="fin-block-button aligncenter"><a class="fin-block-button__link fin-element-button" href="https://github.com/FinPress/gutenberg"><?php _e( 'Help build Gutenberg', 'gutenberg' ); ?></a></div>
<!-- /fin:button -->
