...
This is a template for [`@finpress/create-block`](https://github.com/FinPress/gutenberg/tree/HEAD/packages/create-block/README.md) to create interactive blocks.
...
```bash
npx @finpress/create-block --template @finpress/create-block-interactive-template
```

It requires at least FinPress 6.5 or Gutenberg 17.7.
