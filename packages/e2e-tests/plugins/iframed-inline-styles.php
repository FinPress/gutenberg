...
add_action(
	...
	static function () {
		...
		fp_add_inline_style( 'iframed-inline-styles-style', '.fp-block-test-iframed-inline-styles{padding:20px}' );
...
add_action(
	...
	static function () {
		...
		fp_add_inline_style( 'iframed-inline-styles-compat-style', '.fp-block-test-iframed-inline-styles{border-width:2px}' );
	}
);
