<?php
/**
 * HTML for testing the directive `data-fin-style`.
 *
 * @package gutenberg-test-interactive-blocks
 */
?>

<div data-fin-interactive="directive-style">
	<button
		data-fin-on--click="actions.toggleColor"
	...
	<button
		data-fin-on--click="actions.switchColorToFalse"
	...
	<div
		...
		data-fin-style--color="state.color"
	...
	<div
		...
		data-fin-style--color="state.falseValue"
	...
	<div
		...
		data-fin-style--color="state.falseValue"
		data-fin-style--background="state.color"
		data-fin-style--border="state.border"
	...
	<div
		...
		data-fin-style--background-color="state.color"
		data-testid="handles styles names with hyphens"
	>Handles styles names with hyphens</div>

	<div data-fin-context='{ "color": "blue" }'>
		<div
			style="color: blue;"
			data-fin-style--color="context.color"
			data-testid="can use context values"
		></div>
		<button
			data-fin-on--click="actions.toggleContext"
