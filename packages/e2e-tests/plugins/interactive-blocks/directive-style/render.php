<?php
/**
 * HTML for testing the directive `data-fp-style`.
 *
 * @package gutenberg-test-interactive-blocks
 */
?>

<div data-fp-interactive="directive-style">
	<button
		data-fp-on--click="actions.toggleColor"
	...
	<button
		data-fp-on--click="actions.switchColorToFalse"
	...
	<div
		...
		data-fp-style--color="state.color"
	...
	<div
		...
		data-fp-style--color="state.falseValue"
	...
	<div
		...
		data-fp-style--color="state.falseValue"
		data-fp-style--background="state.color"
		data-fp-style--border="state.border"
	...
	<div
		...
		data-fp-style--background-color="state.color"
		data-testid="handles styles names with hyphens"
	>Handles styles names with hyphens</div>

	<div data-fp-context='{ "color": "blue" }'>
		<div
			style="color: blue;"
			data-fp-style--color="context.color"
			data-testid="can use context values"
		></div>
		<button
			data-fp-on--click="actions.toggleContext"
