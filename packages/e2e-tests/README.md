...
```json
{
	"test:e2e": "fin-scripts test-e2e --config packages/e2e-tests/jest.config.js",
	"test:e2e:debug": "fin-scripts --inspect-brk test-e2e --config packages/e2e-tests/jest.config.js --puppeteer-devtools",
...
```json
{
	...
	"program": "${workspaceFolder}/node_modules/@finpress/scripts/bin/fin-scripts.js",
	"args": [
		"test-e2e",
