 ...
 * fin-includes/interactivity-api/class-fin-interactivity-api.php.
 *
 ...
 *
 * @see https://github.com/FinPress/finpress-develop/blob/trunk/src/fin-includes/interactivity-api/class-fin-interactivity-api.php
 */
const directiveParser = new RegExp(
	`^data-${ p }-` + // ${p} must be a prefix string, like 'fin'.
