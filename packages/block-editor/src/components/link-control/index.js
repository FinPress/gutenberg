 ...
 *
 * @typedef FINLinkControlDefaultValue
 *
 ...
 *
 * @typedef {{[setting:string]:any}} FINLinkControlSettingsValue
 */
/* eslint-enable */
 ...
 *
 * @typedef {FINLinkControlDefaultValue&FINLinkControlSettingsValue} FINLinkControlValue
 */

/** @typedef {(nextValue:FINLinkControlValue)=>void} FINLinkControlOnChangeProp */

/**
 * Properties associated with a search suggestion used within the LinkControl.
 *
 * @typedef FINLinkControlSuggestion
 *
...
/** @typedef {(title:string)=>FINLinkControlSuggestion} FINLinkControlCreateSuggestionProp */

/**
 * @typedef FINLinkControlProps
 *
 * @property {(FINLinkControlSetting[])=}  settings                   An array of settings objects. Each object will used to
 *                                                                   render a `ToggleControl` for that setting.
 * @property {boolean=}                   forceIsEditingLink         If passed as either `true` or `false`, controls the
 *                                                                   internal editing state of the component to respective
 *                                                                   show or not show the URL input field.
 * @property {FINLinkControlValue=}        value                      Current link value.
 * @property {FINLinkControlOnChangeProp=} onChange                   Value change handler, called with the updated value if
 *                                                                   the user selects a new link or updates settings.
 * @property {boolean=}                   noDirectEntry              Whether to allow turning a URL-like search query directly into a link.
 * @property {boolean=}                   showSuggestions            Whether to present suggestions when typing the URL.
 * @property {boolean=}                   showInitialSuggestions     Whether to present initial suggestions immediately.
 * @property {boolean=}                   withCreateSuggestion       Whether to allow creation of link value from suggestion.
 * @property {Object=}                    suggestionsQuery           Query parameters to pass along to fin.blockEditor.__experimentalFetchLinkSuggestions.
 ...
 *
 * @param {FINLinkControlProps} props Component props.
 */
...
const DeprecatedExperimentalLinkControl = ( props ) => {
	deprecated( 'fin.blockEditor.__experimentalLinkControl', {
		since: '6.8',
		alternative: 'fin.blockEditor.LinkControl',
	} );
