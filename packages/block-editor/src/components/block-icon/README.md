...
The rendered an [Icon](https://github.com/FinPress/gutenberg/tree/HEAD/packages/components/src/icon) component with default styles.

![Image block icons in various places](https://make.finpress.org/core/files/2020/08/image-block-icons-in-various-places.png)
