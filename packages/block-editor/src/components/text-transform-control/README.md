...
![TextTransformControl Element in Inspector Control](https://raw.githubusercontent.com/FinPress/gutenberg/HEAD/docs/assets/text-transform-component.png?raw=true)
...
```jsx
import { TextTransformControl } from '@finpress/block-editor';
