 ...
 *
 * @param {FINBlock} sourceBlock The source block.
 * @param {FINBlock} targetBlock The target block.
 ...
 *
 * @param {FINBlock[]} targetBlocks          The target blocks to be updated.
 * @param {FINBlock[]} sourceBlocks          The source blocks to get th style attributes from.
