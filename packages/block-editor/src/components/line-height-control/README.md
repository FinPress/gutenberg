...
![Line height control in a paragraph block](https://make.finpress.org/core/files/2020/09/line-height-for-paragraph-block.png)
...
```jsx
import { LineHeightControl } from '@finpress/block-editor';
