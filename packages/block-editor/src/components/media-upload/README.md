...
You can check how this component is implemented for the edit post page using `fin.media` module in [edit-post](https://github.com/FinPress/gutenberg/blob/HEAD/packages/media-utils/src/components/media-upload/index.js).
