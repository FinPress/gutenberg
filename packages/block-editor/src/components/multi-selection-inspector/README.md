...
The `MultiSelectionInspector` component adds a card in the panel displayed by the [`BlockInspector`](https://github.com/FinPress/gutenberg/tree/HEAD/packages/block-editor/src/components/block-inspector) component when several blocks are selected in the editor.
...
![Multi selection inspector card](https://make.finpress.org/core/files/2020/09/multi-selection-inspector-card.png)
...
```jsx
import { <MultiSelectionInspector /> } from '@finpress/block-editor';
