...
The `LetterSpacingControl` component renders a [`UnitControl`](https://github.com/FinPress/gutenberg/blob/trunk/packages/block-editor/src/components/unit-control/README.md) that lets the user enter a numeric value and select a unit, for example px or rem.

This component is used for blocks that display text, commonly inside a 
[`ToolsPanelItem`](https://github.com/FinPress/gutenberg/blob/trunk/packages/components/src/tools-panel/tools-panel-item/README.md).
...
```jsx
import { __experimentalLetterSpacingControl as LetterSpacingControl } from '@finpress/block-editor';
