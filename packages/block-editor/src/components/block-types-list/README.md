...
![Block types list in the block inserter tab](https://make.finpress.org/core/files/2020/09/block-types-list-emplacement-1.png)

![Block types list in the reusables blocks tab](https://make.finpress.org/core/files/2020/09/block-types-list-emplacement-2.png)

![Block types list in the quick inserter modal](https://make.finpress.org/core/files/2020/09/block-types-list-emplacement-3.png)
...
```jsx
import { BlockTypesList } from '@finpress/block-editor';
...
On Mobile usually this component is rendered inside `BottomSheet` component, which already [generates these props](<(https://github.com/FinPress/gutenberg/blob/1ca1fe0c64dfe1a385221399fc94b0fb14f34199/packages/components/src/mobile/bottom-sheet/index.native.js#L355-L372)>) for this component.
