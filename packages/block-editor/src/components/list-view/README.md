...
![List view](https://make.finpress.org/core/files/2020/08/block-navigation.png)
![View of a group list view](https://make.finpress.org/core/files/2020/08/view-of-group-block-navigation.png)
...
```jsx
import { ListView } from '@finpress/block-editor';
