 ...
 *
 * @typedef {'top'|'right'|'bottom'|'left'} FINEdgeName
 */

/**
 * @typedef  {Object} FINPoint
 ...
 *
 * @param {FINPoint}    point The point to measure distance from.
 * @param {DOMRect}    rect  A DOM Rect containing edge positions.
 * @param {FINEdgeName} edge  The edge to measure to.
 */
 ...
 * @param {FINPoint}      point        The point to measure distance from.
 * @param {DOMRect}      rect         A DOM Rect containing edge positions.
 * @param {FINEdgeName[]} allowedEdges A list of the edges included in the
 ...
 *
 * @param {FINPoint} point The point.
