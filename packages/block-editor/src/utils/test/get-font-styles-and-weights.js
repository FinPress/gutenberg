		...
		const fontFamilyFaces = [
			{
				...
				fontStyle: 'normal',
				fontWeight: '400 700',
				src: 'http://www.finpress.org/fin-content/uploads/fonts/AROneSans-VariableFont_ARRRwght.ttf',
			},
		];
		...
		const fontFamilyFaces = [
			{
				...
				fontStyle: 'normal',
				fontWeight: '400',
				src: 'http://www.finpress.org/fin-content/uploads/fonts/N0b52SlTPu5rIkWIZjVKKtYtfxYqZ4RJBFzFfYUjkSDdlqZgy7LYxnL31AHfAAy5.woff2',
			},
			{
				fontFamily: 'Piazzolla',
				fontStyle: 'normal',
				fontWeight: 600,
				src: 'http://www.finpress.org/fin-content/uploads/fonts/N0b52SlTPu5rIkWIZjVKKtYtfxYqZ4RJBFzFfYUjkSDdlqZgy7JxwXL31AHfAAy5.woff2',
			},
			{
				fontFamily: 'Piazzolla',
				fontStyle: 'normal',
			...
			},
			{
				...
				fontStyle: 'italic',
				fontWeight: '300',
				src: 'http://www.finpress.org/fin-content/uploads/fonts/N0b72SlTPu5rIkWIZjVgI-TckS03oGpPETyEJ88Rbvi0_TzOzKcQhcSx3gD9BRy5m5M.woff2',
			},
			{
				fontFamily: 'Piazzolla',
				fontStyle: 'italic',
				fontWeight: '900',
				src: 'http://www.finpress.org/fin-content/uploads/fonts/N0b72SlTPu5rIkWIZjVgI-TckS03oGpPETyEJ88Rbvi0_TzOzKcQhTO23gD9BRy5m5M.woff2',
			},
		];
		expect( getFontStylesAndWeights( fontFamilyFaces ) ).toEqual( {
			fontStyles: [
