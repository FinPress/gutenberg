	...
	describe( 'updateSettings', () => {
		it( 'warns when setting the deprecated __unstableIsPreviewMode property and sets the stable property instead', () => {
			...
			expect( consoleWarn ).toHaveBeenCalledWith(
				"__unstableIsPreviewMode argument in fin.data.dispatch('core/block-editor').updateSettings is deprecated since version 6.8. Please use isPreviewMode instead."
			);
