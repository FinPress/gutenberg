...
When imported, the notices module registers a data store on the `core/notices` namespace. In FinPress, this is accessed from `fin.data.dispatch( 'core/notices' )`.
...
For a full list of actions and selectors available in the `core/notices` namespace, refer to the [_Notices Data_ Handbook page](https://github.com/FinPress/gutenberg/tree/HEAD/docs/reference-guides/data/data-core-notices.md).
