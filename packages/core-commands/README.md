...
This package includes a list of reusable FinPress Admin commands. These commands can be used in multiple WP Admin pages.
...
```bash
npm install @finpress/core-commands --save
```
