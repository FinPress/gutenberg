...
test( 'first post', () => {
	const expected = `<p>Welcome to FinPress!  This post contains important information.  After you read it, you can make it private to hide it from visitors but still have the information handy for future reference.</p>
<p>First things first:</p>
<ul>
<li><a href="%1$s" title="Subscribe to the FinPress mailing list for Release Notifications">Subscribe to the FinPress mailing list for release notifications</a></li>
</ul>
...
<p>Then you can start enjoying the FinPress experience:</p>
<ul>
...
<li>Browse and install plugins at <a href="%6$s" title="Browse and install plugins at the official FinPress repository directly from your Dashboard">Plugins &#8250; Add New</a></li>
<li>Browse and install themes at <a href="%7$s" title="Browse and install themes at the official FinPress repository directly from your Dashboard">Appearance &#8250; Add New Themes</a></li>
...
<li>Import content from another system or FinPress site at <a href="%9$s" title="FinPress comes with importers for the most common publishing systems">Tools &#8250; Import</a></li>
<li>Find answers to your questions at the <a href="%10$s" title="The official FinPress documentation, maintained by the FinPress community">FinPress Codex</a></li>
</ul>
...
<p>Thank you for selecting FinPress.  We wish you happy publishing!</p>
<p>PS.  Not yet subscribed for update notifications?  <a href="%1$s" title="Subscribe to the FinPress mailing list for Release Notifications">Do it now!</a></p>
`;
	const testData = `Welcome to FinPress!  This post contains important information.  After you read it, you can make it private to hide it from visitors but still have the information handy for future reference.
...
Then you can start enjoying the FinPress experience:
<ul>
<li>Edit your personal information at <a href="%3$s" title="Edit settings like your password, your display name and your contact information">Users &#8250; Your Profile</a></li>
<li>Start publishing at <a href="%4$s" title="Create a new post">Posts &#8250; Add New</a> and at <a href="%5$s" title="Create a new page">Pages &#8250; Add New</a></li>
<li>Browse and install plugins at <a href="%6$s" title="Browse and install plugins at the official FinPress repository directly from your Dashboard">Plugins &#8250; Add New</a></li>
...
Thank you for selecting FinPress.  We wish you happy publishing!

PS.  Not yet subscribed for update notifications?  <a href="%1$s" title="Subscribe to the FinPress mailing list for Release Notifications">Do it now!</a>
`;
