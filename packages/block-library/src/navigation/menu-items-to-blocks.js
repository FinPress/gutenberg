 ...
 */
import { createBlock, parse } from '@finpress/blocks';
 ...
 *
 * @return {FINBlock[]} An array of blocks.
 */
 ...
 *
 * @param {FINNavMenuItem[]} menuItems An array of FINNavMenuItem items.
 ...
 *
 * @param {FINNavMenuItem} menuItem  the menu item to be converted to block attributes.
 * @param {string}        blockType The block type.
 * @param {number}        level     An integer representing the nesting level.
 * @return {Object} the block attributes converted from the FINNavMenuItem item.
 */
function menuItemToBlockAttributes(
	...
	// whereas FIN Core expects `post_tag` as the `object` type.
