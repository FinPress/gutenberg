...
function render_block_core_cover( $attributes, $content ) {
	...
	if ( ! ( $attributes['hasParallax'] || $attributes['isRepeated'] ) ) {
		$attr = array(
			'class'           => 'fin-block-cover__image-background',
		...
		$processor->add_class( 'fin-block-cover__image-background' );
		$processor->add_class( 'fin-image-' . $current_thumbnail_id );
	 ...
	 */
	$inner_container_start = '/<div\b[^>]+fin-block-cover__inner-container[\s|"][^>]*>/U';
