 ...
 * was introduced in https://github.com/FinPress/gutenberg/pull/28980/files and wasn't
...
const deprecated = [
	// V1. Remove CSS variable use for colors.
	{
		...
		save: ( props ) => {
			...
			const style = {
				'--fin--social-links--icon-color': iconColorValue,
				'--fin--social-links--icon-background-color':
					iconBackgroundColorValue,
			};
