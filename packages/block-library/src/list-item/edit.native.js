...
export default function ListItemEdit( {
	...
	const blockProps = useBlockProps( {
		...( hasInnerBlocks && styles[ 'fin-block-list-item__nested-blocks' ] ),
	} );
	...
	const defaultPlaceholderFromScheme = usePreferredColorSchemeStyle(
		styles[ 'fin-block-list-item__list-item-placeholder' ],
		styles[ 'fin-block-list-item__list-item-placeholder--dark' ]
	);
	...
	return (
		<View style={ styles[ 'fin-block-list-item__list-item-parent' ] }>
			<View style={ styles[ 'fin-block-list-item__list-item' ] }>
				<View style={ styles[ 'fin-block-list-item__list-item-icon' ] }>
					<ListStyleType
				...
				<View
					style={ styles[ 'fin-block-list-item__list-item-content' ] }
					onLayout={ onLayout }
				>
					<RichText
