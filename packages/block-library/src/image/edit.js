...
/**
 * Checks if FIN generated the specified image size. Size generation is skipped
...
export function ImageEdit( {
	...
	function onSelectImage( media ) {
		...
		if ( ! linkDestination ) {
			...
			// The constants used in Gutenberg do not match FIN options so a little more complicated than ideal.
			// TODO: fix this in a follow up PR, requires updating media-text and ui component.
			switch (
				window?.fin?.media?.view?.settings?.defaultProps?.link ||
				LINK_DESTINATION_NONE
			) {
				case 'file':
