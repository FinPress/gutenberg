...
/**
 * Deprecation for unconditionally saving the `<figcaption>` element, even if the `caption`
 * attribute is empty. Required to make that attribute work with Block Bindings.
 * Empty `<figcaption>` elements will be removed at render time.
 */
const v9 = {
	attributes: {
		blob: {
