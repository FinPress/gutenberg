...
const variations = [
	...
	},
	{
		...
		keywords: [ __( 'social' ) ],
		description: __( 'Embeds a Facebook post.' ),
		scope: [ 'block' ],
		patterns: [],
		attributes: {
	...
	},
	{
		...
		description: __( 'Embeds an Instagram post.' ),
		scope: [ 'block' ],
		patterns: [],
	...
	},
	{
		...
		description: __( 'Embeds SoundCloud content.' ),
	...
	},
	{
		...
		keywords: [ __( 'music' ), __( 'audio' ) ],
		description: __( 'Embeds Spotify content.' ),
	...
	},
	{
		...
		keywords: [ __( 'image' ) ],
		description: __( 'Embeds Flickr content.' ),
		patterns: [
	...
	},
	{
		...
		icon: embedVimeoIcon,
		keywords: [ __( 'video' ) ],
		description: __( 'Embeds a Vimeo video.' ),
	...
	},
	{
		...
		description: __( 'Embeds an Animoto video.' ),
	...
	},
	{
		...
		description: __( 'Embeds Cloudup content.' ),
	...
	},
	{
		...
		icon: embedVideoIcon,
		description: __( 'Embeds CollegeHumor content.' ),
		scope: [ 'block' ],
		patterns: [],
	...
	},
	{
		...
		description: __( 'Embeds Crowdsignal (formerly Polldaddy) content.' ),
		patterns: [
	...
	},
	{
		...
		keywords: [ __( 'video' ) ],
		description: __( 'Embeds a Dailymotion video.' ),
	...
	},
	{
		...
		icon: embedPhotoIcon,
		description: __( 'Embeds Imgur content.' ),
	...
	},
	{
		...
		icon: embedContentIcon,
		description: __( 'Embeds Issuu content.' ),
	...
	},
	{
		...
		icon: embedContentIcon,
		description: __( 'Embeds Kickstarter content.' ),
		patterns: [
	...
	},
	{
		...
		icon: embedAudioIcon,
		keywords: [ __( 'music' ), __( 'audio' ) ],
		description: __( 'Embeds Mixcloud content.' ),
	...
	},
	{
		...
		description: __( 'Embeds a podcast player from Pocket Casts.' ),
	...
	},
	{
		...
		description: __( 'Embeds a Reddit thread.' ),
	...
	},
	{
		...
		icon: embedAudioIcon,
		description: __( 'Embeds ReverbNation content.' ),
	...
	},
	{
		...
		icon: embedVideoIcon,
		description: __( 'Embeds Screencast content.' ),
	...
	},
	{
		...
		icon: embedContentIcon,
		description: __( 'Embeds Scribd content.' ),
	...
	},
	{
		...
		icon: embedPhotoIcon,
		description: __( 'Embeds SmugMug content.' ),
	...
	},
	{
		...
		icon: embedContentIcon,
		description: __( 'Embeds Speaker Deck content.' ),
	...
	},
	{
		...
		icon: embedVideoIcon,
		keywords: [ __( 'video' ) ],
		description: __( 'Embeds a TikTok video.' ),
	...
	},
	{
		...
		title: getTitle( 'TED' ),
		icon: embedVideoIcon,
		description: __( 'Embeds a TED video.' ),
	...
	},
	{
		...
		keywords: [ __( 'social' ) ],
		description: __( 'Embeds a Tumblr post.' ),
	...
	},
	{
		...
		icon: embedVideoIcon,
		keywords: [ __( 'video' ) ],
		description: __( 'Embeds a VideoPress video.' ),
	...
	},
	{
		...
		icon: embedVideoIcon,
		description: __( 'Embeds a WordPress.tv video.' ),
	...
	},
	{
		...
		keywords: [ __( 'ebook' ) ],
		description: __( 'Embeds Amazon Kindle content.' ),
		patterns: [
	...
	},
	{
		...
		description: __( 'Embeds Pinterest pins, boards, and profiles.' ),
		patterns: [
	...
	},
	{
		...
		description: __( 'Embeds Wolfram notebook content.' ),
	...
	},
	{
		...
		description: __( 'Embeds a Bluesky post.' ),
