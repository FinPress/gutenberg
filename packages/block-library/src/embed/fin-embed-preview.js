...
export default function WpEmbedPreview( { html } ) {
	...
	useEffect( () => {
		 ...
		 * https://github.com/FinPress/FinPress/blob/HEAD/fin-includes/js/fin-embed-template.js#L143
		 * FinPress core embed-template on resize:
		 * https://github.com/FinPress/FinPress/blob/HEAD/fin-includes/js/fin-embed-template.js#L187
		 *
		 * @param {MessageEvent} event Message event.
		 */
		function resizeFINembeds( { data: { secret, message, value } = {} } ) {
		...
		defaultView.addEventListener( 'message', resizeFINembeds );
		return () => {
			defaultView.removeEventListener( 'message', resizeFINembeds );
		};
	}, [] );
