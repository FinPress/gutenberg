...
import {
	...
	LINK_DESTINATION_MEDIA_FIN_CORE,
	LINK_DESTINATION_ATTACHMENT_FIN_CORE,
...
export function getHrefAndDestination(
	...
	// option is set we need to map from the FIN Core values.
	switch ( imageDestination ? imageDestination : galleryDestination ) {
		case LINK_DESTINATION_MEDIA_FIN_CORE:
		...
		case LINK_DESTINATION_ATTACHMENT_FIN_CORE:
