...
export default function GapStyles( { blockGap, clientId } ) {
	...
	// gap on the gallery.
	const fallbackValue = `var( --fin--style--gallery-gap-default, var( --gallery-block--gutter-size, var( --fin--style--block-gap, 0.5em ) ) )`;
	...
	const gap = `#block-${ clientId } {
		--fin--style--unstable-gallery-gap: ${ column === '0' ? '0px' : column };
		gap: ${ gapValue }
	}`;
