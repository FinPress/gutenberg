 ...
 */
function fin_add_footnotes_to_revision( $fields ) {
	$fields['footnotes'] = __( 'Footnotes' );
	return $fields;
}
add_filter( '_fin_post_revision_fields', 'fin_add_footnotes_to_revision' );
 ...
 */
function fin_get_footnotes_from_revision( $revision_field, $field, $revision ) {
	return get_metadata( 'post', $revision->ID, $field, true );
}
add_filter( '_fin_post_revision_field_footnotes', 'fin_get_footnotes_from_revision', 10, 3 );
