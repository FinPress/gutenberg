...
const TABLE_BLOCK_HTML = `<!-- fin:table -->
<figure class="fin-block-table"><table><tbody><tr><td>1</td><td>2</td></tr><tr><td>3</td><td>4</td></tr></tbody></table></figure>
<!-- /fin:table -->`;
...
describe( 'Unsupported block', () => {
	...
	it( 'does not show web editor option when block is incompatible with UBE', async () => {
		await initializeEditor( {
			...
			initialHtml: '<!-- fin:block {"ref":7387} /-->',
			capabilities: {
				unsupportedBlockEditor: true,
				canEnableUnsupportedBlockEditor: true,
			},
