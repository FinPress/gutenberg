...
export default function PostExcerptEditor( {
	 ...
	 * See: https://core.trac.finpress.org/browser/branches/6.1/src/fin-includes/post.php#L65
	...
	const readMoreLink = (
		<RichText
			identifier="moreText"
			className="fin-block-post-excerpt__more-link"
			tagName="a"
	...
	const excerptClassName = clsx( 'fin-block-post-excerpt__excerpt', {
	...
	return (
		<>
			...
			<div { ...blockProps }>
				...
				{ ! showMoreOnNewLine && ' ' }
				{ showMoreOnNewLine ? (
					<p className="fin-block-post-excerpt__more-text">
						{ readMoreLink }
					</p>
				) : (
					readMoreLink
