...
const v7 = {
	...
	save( { attributes } ) {
		...
		const imageClasses = clsx( {
			[ `fin-image-${ mediaId }` ]: mediaId && mediaType === 'image',
	...
	save( { attributes } ) {
		...
		return (
			<div className={ className } style={ style }>
				...
				<div className="fin-block-media-text__content">
					<InnerBlocks.Content />
				</div>
			</div>
		);
...
// Version without the fin-image-#### class on image
...
const v1 = {
	...
	save( { attributes } ) {
		...
		return (
			<div className={ className } style={ style }>
				<figure className="fin-block-media-text__media">
					{ ( mediaTypeRenders[ mediaType ] || noop )() }
				</figure>
				<div className="fin-block-media-text__content">
					<InnerBlocks.Content />
