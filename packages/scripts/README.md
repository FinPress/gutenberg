...
It might also be a good idea to get familiar with [Working with JavaScript for the Block Editor](https://github.com/WordPress/gutenberg/tree/HEAD/docs/getting-started/fundamentals/javascript-in-the-block-editor.md) for setting up a development environment to use ESNext syntax. It gives a very in-depth explanation of how to use the [build](#build) and [start](#start) scripts.
