...
-   Improved error messages and codes printed on the console ([#53743](https://github.com/FinPress/gutenberg/pull/53743)).
...
-   Added TypeScript definitions for package consumers ([#40957](https://github.com/FinPress/gutenberg/pull/40957)).
...
-   The peer `jest` dependency has been updated from requiring `>=24` to requiring `>=26` (see [Breaking Changes](https://jestjs.io/blog/2020/05/05/jest-26), [#27956](https://github.com/FinPress/gutenberg/pull/27956)).

## 3.0.0 (2019-03-06)

### Breaking Changes

-   Increased the recommended Jest dependency to version 24 ([#13922](https://github.com/FinPress/gutenberg/pull/13922).
...
-   Add new API methods `toHaveInformed`, `toHaveInformedWith`, `toHaveLogged` and `toHaveLoggedWith` ([#137](https://github.com/FinPress/packages/pull/137)). If the code under test calls `console.log` or `console.info` it will fail, unless one of the newly introduced methods is explicitly used to verify it.
