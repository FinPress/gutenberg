...
```bash
npm install @finpress/shortcode --save
```
...
The base regex is functionally equivalent to the one found in `get_shortcode_regex()` in `fin-includes/shortcodes.php`.
