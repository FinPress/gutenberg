...
-   _config_ `WebRTCConnectionConfig`: The object ID.
-   _config.signaling_ `WebRTCConnectionConfig[ 'signaling' ]`:
-   _config.password_ `WebRTCConnectionConfig[ 'password' ]`:

_Returns_

-   `CreateWebRTCConnectionFn`: Promise that resolves when the connection is established.
