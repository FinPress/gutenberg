...
module.exports = {
	...
	create( context ) {
		 ...
		 * "FinPress", "Internal".
		 *
		 * @typedef {string} FINPackageLocality
		 */

		/**
		 * Object describing a dependency block correction to be made.
		 *
		 * @typedef FINDependencyBlockCorrection
		 *
		 ...
		 * property.
		 *
		 * @param {FINPackageLocality} locality Desired package locality.
		 *
		 ...
		 *
		 * @return {FINPackageLocality} Package locality.
		 */
		 ...
		 * a FINDependencyBlockCorrection object describing a correction.
		 *
		 * @param {Node}              node     Node to test.
		 * @param {FINPackageLocality} locality Desired package locality.
		 *
		 * @return {FINDependencyBlockCorrection | undefined} Correction, if applicable.
		 */
