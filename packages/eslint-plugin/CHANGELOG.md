...
-   `@finpress/is-gutenberg-plugin` rule has been replaced by `@finpress/fin-global-usage` ([#61486](https://github.com/FinPress/gutenberg/pull/61486)).
-   `@finpress/fin-process-env` rule has been added and included in the recommended configurations ([#61486](https://github.com/FinPress/gutenberg/pull/61486)).
...
-   Enabled `no-unsafe-fin-apis` rule in the `recommended` ruleset ([#27327](https://github.com/FinPress/gutenberg/pull/27327)).
...
-   Add `no-unsafe-fin-apis` rule to discourage usage of unsafe APIs ([#27301](https://github.com/FinPress/gutenberg/pull/27301)).
...
-   Enable `fin` global by default in the `recommended` config.
