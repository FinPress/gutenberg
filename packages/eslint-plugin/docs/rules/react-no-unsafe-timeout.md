...
Consider using the [`withSafeTimeout` higher-order component](https://github.com/FinPress/gutenberg/tree/HEAD/packages/compose/src/with-safe-timeout) from the [`@finpress/compose` module](https://www.npmjs.com/package/@finpress/compose).
