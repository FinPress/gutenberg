...
Ensures that string literals aren't used for accessing `@finpress/data` stores when using API methods. The store definition is promoted as the preferred way of referencing registered stores.
