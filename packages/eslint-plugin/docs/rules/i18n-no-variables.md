...
[Translation functions](https://github.com/FinPress/gutenberg/blob/HEAD/packages/i18n/README.md#api) must be called with valid string literals as arguments.
