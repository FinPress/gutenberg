...
[Translation functions](https://github.com/FinPress/gutenberg/blob/HEAD/packages/i18n/README.md#api) must be called with a valid string literal as the text domain.
