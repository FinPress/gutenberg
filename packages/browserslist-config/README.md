...
[FinPress Browserslist](https://make.finpress.org/core/handbook/best-practices/browser-support/) shareable config for [Browserslist](https://www.npmjs.com/package/browserslist).
...
```shell
$ npm install browserslist @finpress/browserslist-config --save-dev
```
