 ...
 * or a component.
 *
 * @typedef {(string|Element|Component)} FINIcon
 *
 ...
 * or a component.
 *
 * @typedef {FINIcon} FINBlockTypeIconRender
 */

/**
 * An object describing a normalized block type icon.
 *
 * @typedef {Object} FINBlockTypeIconDescriptor
 *
 * @property {FINBlockTypeIconRender} src         Render behavior of the icon,
 ...
 * the icon.
 *
 * @typedef {(FINBlockTypeIconDescriptor|FINBlockTypeIconRender)} FINBlockTypeIcon
 */

/**
 * Named block variation scopes.
 *
 * @typedef {'block'|'inserter'|'transform'} FINBlockVariationScope
 */

/**
 * An object describing a variation defined for the block type.
 *
 * @typedef {Object} FINBlockVariation
 *
 ...
 * @property {FINIcon}                  [icon]        An icon helping to visualize the variation.
 ...
 *                                                   for the block type.
 * @property {FINBlockVariationScope[]} [scope]       The list of scopes where the variation
 ...
 *                                              used in search interfaces to arrange
 *                                              block types by category.
 * @property {FINBlockTypeIcon}    [icon]        Block type icon.
 ...
 * @property {FINBlockVariation[]} [variations]  The list of block variations.
 * @property {Object}             [example]     Example provides structured data for
 ...
 *
 * @typedef {Object} FINBlockBindingsSource
 *
 * @property {string}   name               The unique and machine-readable name.
 ...
 * ```
 *
 * @return {FINBlockType | undefined} The previous block value, if it has been successfully
 ...
 * @param {FINBlockVariation} variation Object describing a block variation.
 *
 * @example
 * ```js
 * import { __ } from '@finpress/i18n';
 ...
 *
 * @param {FINBlockBindingsSource} source Object describing a block bindings source.
 *
 * @example
 * ```js
 * import { _x } from '@finpress/i18n';
