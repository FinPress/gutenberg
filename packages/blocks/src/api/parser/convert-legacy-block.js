...
export function convertLegacyBlockNameAndAttributes( name, attributes ) {
	...
	// Column count was stored as a string from FIN 6.3-6.6. Convert it to a number.
	if (
	...
	// Column span and row span were stored as strings in FIN 6.6. Convert them to numbers.
