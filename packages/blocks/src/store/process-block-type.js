 ...
 * @param {FINBlockType} blockSettings Unprocessed block type settings.
 *
 * @return {FINBlockType | undefined} The block, if it has been processed and can be registered; otherwise `undefined`.
 */
