...
This package includes a library of generic FinPress components to be used for creating common UI elements shared between screens and features of the FinPress dashboard.

## Installation

```bash
npm install @finpress/components --save
```
...
Many components include CSS to add styles, which you will need to load in order for them to appear correctly. Within FinPress, add the `fin-components` stylesheet as a dependency of your plugin's stylesheet. See [fin_enqueue_style documentation](https://developer.finpress.org/reference/functions/fin_enqueue_style/#parameters) for how to specify dependencies.
 ...
 */
import { Popover, SlotFillProvider } from '@finpress/components';
...
You can browse the components docs and examples at [https://finpress.github.io/gutenberg/](https://finpress.github.io/gutenberg/)
...
This package also has its own [contributing information](https://github.com/FinPress/gutenberg/tree/HEAD/packages/components/CONTRIBUTING.md) where you can find additional details.
