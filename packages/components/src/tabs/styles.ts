...
export const StyledTabList = styled( Ariakit.TabList )`
	...
	&[aria-orientation='horizontal'] {
		...
		&::before {
			...
			border-bottom: var( --fin-admin-border-width-focus ) solid
				${ COLORS.theme.accent };
		}
	}
	&[aria-orientation='vertical'] {
...
export const Tab = styled( Ariakit.Tab )`
	& {
		...
		&::after {
			...
			outline: var( --fin-admin-border-width-focus ) solid
				${ COLORS.theme.accent };
			border-radius: ${ CONFIG.radiusSmall };
	...
	[aria-orientation='vertical'][data-select-on-move='false'] &::after {
		content: '';
		inset: var( --fin-admin-border-width-focus );
	}
`;
