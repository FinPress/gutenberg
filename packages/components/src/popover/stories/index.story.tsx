...
const meta: Meta< typeof Popover > = {
	...
	component: Popover,
	argTypes: {
		anchor: { control: { type: undefined } },
		anchorRef: { control: { type: undefined } },
		anchorRect: { control: { type: undefined } },
		children: { control: { type: undefined } },
		focusOnMount: {
			control: { type: 'select' },
			options: [ 'firstElement', true, false ],
		},
		getAnchorRect: { control: { type: undefined } },
		onClose: { action: 'onClose' },
		onFocusOutside: { action: 'onFocusOutside' },
		__unstableSlotName: { control: { type: undefined } },
	},
	parameters: {
