...
if ( ! class_exists( 'FIN_Style_Engine' ) ) {

	/**
	 * Class FIN_Style_Engine.
	 *
	...
	final class FIN_Style_Engine {
		...
		public static function get_store( $store_name ) {
			return FIN_Style_Engine_CSS_Rules_Store::get_store( $store_name );
		}
		...
		public static function compile_css( $css_declarations, $css_selector ) {
			...
			if ( $css_selector ) {
				$css_rule = new FIN_Style_Engine_CSS_Rule( $css_selector, $css_declarations );
				return $css_rule->get_css();
			}

			$css_declarations = new FIN_Style_Engine_CSS_Declarations( $css_declarations );
		 ...
		 *
		 * @param FIN_Style_Engine_CSS_Rule[] $css_rules An array of FIN_Style_Engine_CSS_Rule objects from a store or otherwise.
		 * @param array                      $options   {
		 *     Optional. An array of options. Default empty array.
		 *
		...
		public static function compile_stylesheet_from_css_rules( $css_rules, $options = array() ) {
			$processor = new FIN_Style_Engine_Processor();
