...
if ( ! class_exists( 'FIN_Style_Engine_CSS_Declarations' ) ) {
	 ...
	 * @access private
	 */
	class FIN_Style_Engine_CSS_Declarations {
		/**
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Declarations Returns the object to allow chaining methods.
		 */
