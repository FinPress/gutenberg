...
if ( ! class_exists( 'FP_Style_Engine_CSS_Rule' ) ) {
	...
	class FP_Style_Engine_CSS_Rule {
		 ...
		 * @param string[]|FP_Style_Engine_CSS_Declarations $declarations An associative array of CSS definitions, e.g., array( "$property" => "$value", "$property" => "$value" ),
		 ...
		 *
		 * @param array|FP_Style_Engine_CSS_Declarations $declarations An array of declarations (property => value pairs),
		 *                                                             or a FP_Style_Engine_CSS_Declarations object.
		 *
		 * @return FP_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
		 */
