...
if ( ! class_exists( 'FIN_Style_Engine_CSS_Rule' ) ) {
	 ...
	 * @access private
	 */
	class FIN_Style_Engine_CSS_Rule {
		 ...
		 *
		 * Contains a FIN_Style_Engine_CSS_Declarations object.
		 *
		 * @var FIN_Style_Engine_CSS_Declarations
		 */
		 ...
		 * @param string[]|FIN_Style_Engine_CSS_Declarations $declarations An associative array of CSS definitions, e.g., array( "$property" => "$value", "$property" => "$value" ),
		 *                                                                or a FIN_Style_Engine_CSS_Declarations object.
		 ...
		 * @param string $selector The CSS selector.
		 *
		 * @return FIN_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
		 */
		 ...
		 *
		 * @param array|FIN_Style_Engine_CSS_Declarations $declarations An array of declarations (property => value pairs),
		 *                                                             or a FIN_Style_Engine_CSS_Declarations object.
		 *
		 * @return FIN_Style_Engine_CSS_Rule Returns the object to allow chaining of methods.
		 */
		public function add_declarations( $declarations ) {
			...
			if ( null === $this->declarations ) {
				...
				$this->declarations = new FIN_Style_Engine_CSS_Declarations( $declarations_array );
			}
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Declarations The declarations object.
		 */
