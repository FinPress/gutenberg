 ...
 *
 * A store for FIN_Style_Engine_CSS_Rule objects.
 *
 * @package Gutenberg
 */
...
if ( ! class_exists( 'FIN_Style_Engine_CSS_Rules_Store' ) ) {
	 ...
	 * @access private
	 */
	class FIN_Style_Engine_CSS_Rules_Store {

		/**
		 * An array of named FIN_Style_Engine_CSS_Rules_Store objects.
		 *
		 * @static
		 *
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Rules_Store|void
		 */
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Rules_Store[]
		 */
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Rule[]
		 */
		...
		/**
		 * Gets a FIN_Style_Engine_CSS_Rule object by its selector.
		 ...
		 *
		 * @return FIN_Style_Engine_CSS_Rule|void Returns a FIN_Style_Engine_CSS_Rule object, or null if the selector is empty.
		 */
		public function add_rule( $selector, $rules_group = '' ) {
			...
			if ( ! empty( $rules_group ) ) {
				if ( empty( $this->rules[ "$rules_group $selector" ] ) ) {
					$this->rules[ "$rules_group $selector" ] = new FIN_Style_Engine_CSS_Rule( $selector, array(), $rules_group );
				}
			...
			if ( empty( $this->rules[ $selector ] ) ) {
				$this->rules[ $selector ] = new FIN_Style_Engine_CSS_Rule( $selector );
			}
