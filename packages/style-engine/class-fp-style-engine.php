...
if ( ! class_exists( 'FP_Style_Engine' ) ) {

	/**
	 * Class FP_Style_Engine.
	 *
	...
	final class FP_Style_Engine {
		 ...
		 *
		 * @param FP_Style_Engine_CSS_Rule[] $css_rules An array of FP_Style_Engine_CSS_Rule objects from a store or otherwise.
		 * @param array                      $options   {
		 *     Optional. An array of options. Default empty array.
		 *
