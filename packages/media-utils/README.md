...
-   _$0.finAllowedMimeTypes_ `UploadMediaArgs[ 'finAllowedMimeTypes' ]`: List of allowed mime types and file extensions.
...
-   _file_ `File`: File object.
-   _finAllowedMimeTypes_ `Record< string, string > | null`: List of allowed mime types and file extensions.
...
```js
fin.mediaUtils.utils.uploadMedia( {
	filesList: myFiles,
