...
-   _$0.fpAllowedMimeTypes_ `UploadMediaArgs[ 'fpAllowedMimeTypes' ]`: List of allowed mime types and file extensions.
...
-   _file_ `File`: File object.
-   _fpAllowedMimeTypes_ `Record< string, string > | null`: List of allowed mime types and file extensions.
...
```js
fp.mediaUtils.utils.uploadMedia( {
	filesList: myFiles,
