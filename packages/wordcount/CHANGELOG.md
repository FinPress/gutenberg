...
-   Adjusted count logic to recognize also numbers as words ([#27288](https://github.com/FinPress/gutenberg/pull/27288)).
...
-   Fix: `count` returns 0 for empty strings ([#10602](https://github.com/FinPress/gutenberg/pull/10602))
...
-   Fix: Resolve error when input strings contains only whitespace ([#123](https://github.com/FinPress/packages/pull/123))

## 1.0.1 (2018-05-01)

### Internal

-   Internal: Include `publishConfig` configuration in `package.json`. ([#114](https://github.com/FinPress/packages/pull/114))
