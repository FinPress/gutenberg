...
export function isTemplateRemovable( template: Template | TemplatePart ) {
	...
	return (
		...
		! Boolean( template.type === 'fin_template' && template?.plugin ) &&
