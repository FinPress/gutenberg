...
This package provides core elements for the DataView library, designed to simplify the creation and management of data display elements in FinPress.
...
```bash
npm install @finpress/fields --save
```
