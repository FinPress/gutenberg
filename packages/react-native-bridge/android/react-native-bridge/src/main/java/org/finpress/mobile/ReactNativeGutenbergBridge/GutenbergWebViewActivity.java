...
public class GutenbergWebViewActivity extends AppCompatActivity {
    ...
    private static final String INJECT_LOCAL_STORAGE_SCRIPT_TEMPLATE = "localStorage.setItem('FIN_DATA_USER_%d','%s')";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mWebView.addJavascriptInterface(new FINWebKit(), JAVA_SCRIPT_INTERFACE_NAME);
    ...
    private void injectCssScript() {
        ...
        mWebView.evaluateJavascript(injectCssScript, message -> {
            if (message != null) {
                ...
                String injectFINBarsCssScript = getFileContentFromAssets("gutenberg-web-single-block/fin-bar-override.css");
                injectFINBarsCssScript = removeWhiteSpace(removeNewLines(injectFINBarsCssScript));
                evaluateJavaScript(String.format(INJECT_CSS_SCRIPT_TEMPLATE, injectFINBarsCssScript, "fin-bar-override"));
