...
-   Removed unused `@finpress/compose` dependency ([#38388](https://github.com/FinPress/gutenberg/pull/38388)).
...
-   Added a store definition `store` for the reusable blocks namespace to use with `@finpress/data` API ([#26655](https://github.com/FinPress/gutenberg/pull/26655)).

## 1.0.0 (2020-10-19)

### Internal

-   Reusable block utilities moved from `@finpress/editor` to `@finpress/reusable-blocks`.
