...
-   Removed `getStablePath` function. Please use `normalizePath` from `@finpress/url` package instead ([#35992](https://github.com/FinPress/gutenberg/pull/35992)).``

## 5.2.0 (2021-07-21)

### New Features

-   `AbortError` being thrown by the default fetch handler can now be caught and handled separately in user-land. Add documentation about aborting a request ([#32530](https://github.com/FinPress/gutenberg/pull/32530)).
...
-   Added `@finpress/deprecation` package to add deprecation notice to `useApiFetch` hook.
...
-   Always request data in the user's locale ([#10862](https://github.com/FinPress/gutenberg/pull/10862)).
