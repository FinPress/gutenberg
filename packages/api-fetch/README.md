...
Utility to make FinPress REST API requests. It's a wrapper around `window.fetch`.
...
```bash
npm install @finpress/api-fetch --save
```
...
const rootURL = 'http://my-finpress-site/wp-json/';
