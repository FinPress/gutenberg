...
-   Added a store definition `store` for the keyboard shortcuts namespace to use with `@finpress/data` API ([#26655](https://github.com/FinPress/gutenberg/pull/26655)).
