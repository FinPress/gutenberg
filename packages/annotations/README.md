...
```bash
npm install @finpress/annotations --save
```
...
You need to include `fin-annotations` as a dependency of the JavaScript file in which you wish to use the Annotations API.

## Usage

[See this page for more detailed usage instructions](https://developer.finpress.org/block-editor/developers/block-api/block-annotations).
