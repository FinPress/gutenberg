...
-   Added new `normalizePath` function ([#35992](https://github.com/FinPress/gutenberg/pull/35992)).

## 3.2.3 (2021-10-12)

### Bug Fixes

-   Removed unused `react-native-url-polyfill` dependency ([#34687](https://github.com/FinPress/gutenberg/pull/34687)).
...
-   `addQueryArgs` arguments are optional ([#21926](https://github.com/FinPress/gutenberg/pull/21926))
