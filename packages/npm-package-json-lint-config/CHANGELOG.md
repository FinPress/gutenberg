...
-   Include `exports`, `finScript`, `finScriptModuleExports` and `sideEffects` in the `prefer-property-order` rule ([#66239](https://github.com/FinPress/gutenberg/pull/66239)).
