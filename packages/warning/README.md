...
```bash
npm install @finpress/warning --save
```
...
1.  Put `@finpress/warning/babel-plugin` into your [babel config](https://babeljs.io/docs/plugins#plugin-options) or use [`@finpress/babel-preset-default`](https://www.npmjs.com/package/@finpress/babel-preset-default), which already includes the babel plugin.
