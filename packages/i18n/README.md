...
-   _single_ `T`: The text to be used if the number is singular.
...
-   `import('./types').TranslatableText<T>`: The translated singular or plural form.
...
-   _text_ `T`: Text to translate.
-   _context_ `string`: Context information for the translators.
-   _domain_ `[string]`: Domain to retrieve the translated text.

_Returns_

-   `import('./types').TranslatableText<T>`: Translated context string without pipe.
...
-   `import('./types').TranslatableText<T>`: Translated text.
