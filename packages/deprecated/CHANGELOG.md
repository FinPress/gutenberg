...
-   Include TypeScript type declarations ([#26429](https://github.com/FinPress/gutenberg/pull/26429))
...
-   Call `doAction` hook when a deprecated feature is encountered ([#8110](https://github.com/FinPress/gutenberg/pull/8110))
