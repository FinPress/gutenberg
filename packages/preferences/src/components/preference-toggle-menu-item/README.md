...
This component implements a `MenuItem` component from the `@finpress/components` package.
...
Consider using the `displayShortcut` helper from the `@finpress/keycodes` package for this prop.
