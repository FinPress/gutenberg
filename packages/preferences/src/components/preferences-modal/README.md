...
This component implements a `Modal` component from the `@finpress/components` package.

Sections passed to this component should use `PreferencesModalSection` component from the `@finpress/preferences` package.
