 ...
 *
 * @return {import('./actions').FINCommandConfig[]} The list of registered commands.
 */
 ...
 *
 * @return {import('./actions').FINCommandLoaderConfig[]} The list of registered command loaders.
 */
