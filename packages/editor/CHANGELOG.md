...
-   `RichTextProvider` has been removed. Please use `fin.data.select( 'core/editor' )` methods instead.
...
-   `RichTextProvider` flagged for deprecation. Please use `fin.data.select( 'core/editor' )` methods instead.
