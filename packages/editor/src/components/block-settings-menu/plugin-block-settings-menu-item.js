 ...
 * @param {FPBlockTypeIconRender} [props.icon]          The [Dashicon](https://developer.finpress.org/resource/dashicons/) icon slug string, or an SVG FP element.
 ...
 * // Using ES5 syntax
 * var __ = fp.i18n.__;
 * var PluginBlockSettingsMenuItem = fp.editor.PluginBlockSettingsMenuItem;
 *
 * function doOnClick(){
