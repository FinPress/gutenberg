...
[register_taxonomy](https://developer.finpress.org/reference/functions/register_taxonomy).
...
const HierarchicalTermSelector = fin.editor.PostTaxonomiesHierarchicalTermSelector;
