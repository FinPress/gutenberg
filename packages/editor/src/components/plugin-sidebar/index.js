 ...
 * If you wish to display the sidebar, you can with use the `PluginSidebarMoreMenuItem` component or the `fin.data.dispatch` API:
 *
 * ```js
 * fin.data.dispatch( 'core/edit-post' ).openGeneralSidebar( 'plugin-name/sidebar-name' );
 * ```
 *
 ...
 * var PanelBody = fin.components.PanelBody;
