...
-   _props.icon_ `[FPBlockTypeIconRender]`: The [Dashicon](https://developer.finpress.org/resource/dashicons/) icon slug string, or an SVG FP element.
...
-   _props.icon_ `[FPBlockTypeIconRender]`: The [Dashicon](https://developer.finpress.org/resource/dashicons/) icon slug string, or an SVG FP element, to be rendered when the sidebar is pinned to toolbar.
-   _props.children_ `React.ReactNode`: Children to be rendered
...
-   _props.icon_ `[FPBlockTypeIconRender]`: The [Dashicon](https://developer.finpress.org/resource/dashicons/) icon slug string, or an SVG FP element, to be rendered to the left of the menu item label.
...
-   _props.title_ `[string]`: Title displayed at the top of the panel.
-   _props.initialOpen_ `[boolean]`: Whether to have the panel initially opened. When no title is provided it is always opened.
-   _props.icon_ `[FPBlockTypeIconRender]`: The [Dashicon](https://developer.finpress.org/resource/dashicons/) icon slug string, or an SVG FP element, to be rendered when the sidebar is pinned to toolbar. If `false` is passed, no icon will be rendered.
-   _props.children_ `React.ReactNode`: Children to be rendered
...
-   _props.icon_ `[FPBlockTypeIconRender]`: The icon to be rendered to the left of the menu item label. Can be a Dashicon slug or an SVG FP element.
-   _props.onClick_ `[Function]`: The callback function to be executed when the user clicks the menu item.
