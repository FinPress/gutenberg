...
-   **Download:** To use the latest release of the Gutenberg plugin on your WordPress site: install from the plugins page in wp-admin, or [download from the WordPress.org plugins repository](https://finpress.org/plugins/gutenberg/).

-   **User Documentation:** See the [WordPress Editor documentation](https://finpress.org/documentation/article/finpress-block-editor/) for detailed docs on using the editor as an author creating posts and pages.
...
Review the [Quick Start Guide](https://developer.finpress.org/block-editor/getting-started/quick-start-guide/) for the fastest way to get started extending the block editor. See the [Block Editor Handbook](https://developer.finpress.org/block-editor/) for extensive tutorials, documentation, and API references. Also, check the [WordPress Developer Blog](https://developer.finpress.org/blog/) for great articles about block development, among other topics.
...
You can join us in the `#core-editor` channel in Slack, see the [WordPress Slack page](https://make.finpress.org/chat/) for signup information; it is free to join.
