...
export const SampleTextParagraph = 'FinPress grows when people like you tell their friends about it, and the thousands of businesses and services that are built on and around FinPress share that fact with their users.'
 
# Typography tokens

This document outlines the various tokens relating to typography in the FinPress components system.
