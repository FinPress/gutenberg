...
```js
fin.data.dispatch( 'core/annotations' ).addAnnotation( {
	source: 'my-annotations-plugin',
	blockClientId: fin.data.select( 'core/block-editor' ).getBlockOrder()[ 0 ],
...
To help with determining the correct positions, the `fin.richText.create` method can be used. This will split a piece of HTML into text and formats.
