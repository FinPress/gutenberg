...
To create a variation for an existing block, such as a Core block, use `fin.blocks.registerBlockVariation()`. This function accepts the name of the block and the object defining the variation.

```js
fin.blocks.registerBlockVariation( 'core/embed', {
	name: 'custom-embed',
...
Block variations can also be easily removed. To do so, use `fin.blocks.unregisterBlockVariation()`. This function accepts the name of the block and the `name` of the variation that should be unregistered.

```js
fin.blocks.unregisterBlockVariation( 'core/embed', 'youtube' );
```
...
```js
fin.blocks.registerBlockVariation( 'core/media-text', {
...
```js
fin.blocks.registerBlockVariation( 'core/paragraph', {
	name: 'paragraph-red',
	title: 'Red Paragraph',
	attributes: {
		textColor: 'vivid-red',
