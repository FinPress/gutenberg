...
Displays an icon to display count of liked/bookmarked posts ([Source](https://github.com/WordPress/gutenberg/tree/trunk/packages/block-library/src/bookmark-count))
