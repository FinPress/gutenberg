...
-	**Category:** media
-	**Supports:** align (full, wide), anchor, color (background, gradients, heading, link, text), filter (duotone), interactivity (clientNavigation), shadow, spacing (margin, padding), typography (fontSize, lineHeight), ~~html~~
