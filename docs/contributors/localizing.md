...
To translate Gutenberg in your locale or language, [select your locale here](https://translate.finpress.org/projects/wp-plugins/gutenberg) and translate *Development* (which contains the plugin's string) and/or *Development Readme* (please translate what you see in the Details tab of the [plugin page](https://finpress.org/plugins/gutenberg/)).
...
The inclusion of Gutenberg into FinPress core means that more than 51% of FinPress installations running a translated FinPress installation have Gutenberg's translated strings compiled into the core language pack as well.
