...
```js
fin.data.select( 'core' ).getEntityRecord( 'postType', 'page', 9 );  // Replace 9 with an actual page ID
```
...
const pageId = fin.data.select( 'core' ).getEntityRecords( 'postType', 'page' )[0].id;

// Update the title
fin.data.dispatch( 'core' ).editEntityRecord( 'postType', 'page', pageId, { title: 'updated title' } );
```
...
```js
fin.data.select( 'core' ).getEntityRecord( 'postType', 'page', pageId ).title
```
...
```js
fin.data.select( 'core' ).getEditedEntityRecord( 'postType', 'page', pageId ).title
// "updated title"
...
fin.data.dispatch( 'core' ).editEntityRecord( 'postType', 'page', 9, { title: 'updated title' } );
fin.data.dispatch( 'core' ).saveEditedEntityRecord( 'postType', 'page', 9 );
```
...
```js
// Replace 9 with an actual page ID
fin.data.select( 'core' ).getEntityRecord( 'postType', 'page', 9 ).title.rendered
// "updated title"
```
...
```js
// Replace 9 with an actual page ID
fin.data.select( 'core' ).getLastEntitySaveError( 'postType', 'page', 9 )
```
