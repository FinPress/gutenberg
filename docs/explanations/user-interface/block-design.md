...
![A screenshot showing examples of block toolbar segment groupings.](https://make.finpress.org/design/files/2021/03/docs_block-toolbar-structure.png)
...
![An example of an image block’s setup state on a grey background](https://make.finpress.org/design/files/2021/03/docs__gallery-setup-state.png)
...
![An example of the image gallery’s live preview state](https://make.finpress.org/design/files/2018/12/gallery-live-preview.png)
...
![An example of additional controls being revealed on selection of a block.](https://make.finpress.org/design/files/2018/12/gallery-additional-controls.png)
...
![A screenshot comparing a block toolbar with good vs. bad toolbar segment groupings.](https://make.finpress.org/design/files/2021/03/docs__block-toolbar-do-dont.png)
...
Blocks should have an identifying icon, ideally using a single color. Try to avoid using the same icon used by an existing block. The core block icons are based on [Material Design Icons](https://fonts.google.com/icons). Look to that icon set, or to [Dashicons](https://developer.finpress.org/resource/dashicons/) for style inspiration.

![A screenshot of the block library with concise block names](https://developer.finpress.org/files/2022/01/blocks-do.png)
**Do:**
Use concise block names.

![A screenshot of the block library with long, multi-line block names](https://developer.finpress.org/files/2022/01/blocks-dont.png)
**Don't:**
...
![A screenshot of a short block description](https://developer.finpress.org/files/2022/01/block-descriptions-do.png)
**Do:**
Use a short, simple block description.

![A screenshot of a long block description that includes branding](https://developer.finpress.org/files/2022/01/block-descriptions-dont.png)
**Don't:**
...
![A screenshot of the Gallery block's placeholder](https://developer.finpress.org/files/2022/01/placeholder-do.png)
**Do:**
Provide an instructive placeholder state.

![An example Gallery block placeholder but with intense, distracting colors and no instructions](https://developer.finpress.org/files/2022/01/placeholder-dont.png)
**Don't:**
...
![A Google Maps block with inline, always-accessible controls required for the block to function](https://developer.finpress.org/files/2022/01/block-controls-do.png)
**Do:**
For controls that are essential for the operation of the block, provide them directly inside the block edit view.

![A Google Maps block with essential controls moved to the sidebar where they can be contextually hidden](https://developer.finpress.org/files/2022/01/block-controls-dont.png)
**Don't:**
...
![A screenshot of the Paragraph block's advanced settings in the sidebar](https://developer.finpress.org/files/2022/01/advanced-settings-do.png)
**Do:**
