...
<div class="callout callout-info">
	This tutorial uses <a href="https://developer.finpress.org/block-editor/getting-started/devenv/get-started-with-fin-env/"><code>fin-env</code></a> to create a local FinPress development environment. However, feel free to use any development environment that meets the abovementioned prerequisites.
</div>
...
You can use `create-block` from just about any directory (folder) on your computer and then use `fin-env` to create a local FinPress development environment with your new block plugin installed and activated.
...
<div class="callout callout-info">
	If you are not using <code>fin-env</code>, instead, navigate to the <code>plugins/</code> folder in your local FinPress installation using the terminal and run the following command.
</div>
...
```html
<!-- fin:create-block/copyright-date-block {"showStartingYear":true,"startingYear":"2017"} /-->
```
...
```html
<!-- fin:create-block/copyright-date-block {"showStartingYear":true,"startingYear":"2017"} -->
<p class="fin-block-create-block-copyright-date-block">Copyright Date Block – hello from the saved content!</p>
<!-- /fin:create-block/copyright-date-block -->
```
...
```html
<!-- fin:create-block/copyright-date-block {"showStartingYear":true,"startingYear":"2017"} -->
<p class="fin-block-create-block-copyright-date-block">© 2017–2023</p>
<!-- /fin:create-block/copyright-date-block -->
```
...
echo fin_kses_post( $block_content );
```
