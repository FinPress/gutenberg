...
/**
 * Overrides the REST controller for the `fp_global_styles` post type.
 *
...
function gutenberg_override_global_styles_endpoint( array $args ): array {
	$args['rest_controller_class']   = 'FP_REST_Global_Styles_Controller_Gutenberg';
...
add_filter( 'register_fp_global_styles_post_type_args', 'gutenberg_override_global_styles_endpoint' );

/**
 * Registers the Edit Site Export REST API routes.
 */
function gutenberg_register_edit_site_export_controller_endpoints() {
	$edit_site_export_controller = new FP_REST_Edit_Site_Export_Controller_Gutenberg();
