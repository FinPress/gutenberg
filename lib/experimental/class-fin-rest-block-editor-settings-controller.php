<?php
/**
 * REST API: FIN_REST_Block_Editor_Settings_Controller class
 *
 * @package    FinPress
 * @subpackage REST_API
 */
...
if ( ! class_exists( 'FIN_REST_Block_Editor_Settings_Controller' ) ) {
	 ...
	 *
	 * @see FIN_REST_Controller
	 */
	class FIN_REST_Block_Editor_Settings_Controller extends FIN_REST_Controller {
		/**
		 * Constructs the controller.
		 */
		public function __construct() {
			$this->namespace = 'fin-block-editor/v1';
		 ...
		 *
		 * @return FIN_Error|bool True if the request has permission, FIN_Error object otherwise.
		 */
		 ...
		 * @param FIN_REST_Request $request Full details about the request.
		 *
		 * @return FIN_Error|FIN_REST_Response Response object on success, or FIN_Error object on failure.
		 */
		public function get_items( $request ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis
			...
			$editor_context = new FIN_Block_Editor_Context( array( 'name' => $editor_context_name ) );
