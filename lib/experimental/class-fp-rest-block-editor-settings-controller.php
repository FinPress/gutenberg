<?php
/**
 * REST API: FP_REST_Block_Editor_Settings_Controller class
 *
 * @package    FinPress
 * @subpackage REST_API
 */
...
if ( ! class_exists( 'FP_REST_Block_Editor_Settings_Controller' ) ) {
	 ...
	 */
	class FP_REST_Block_Editor_Settings_Controller extends FP_REST_Controller {
		/**
		 * Constructs the controller.
		 */
		public function __construct() {
			$this->namespace = 'fp-block-editor/v1';
		 ...
		 *
		 * @return FP_Error|bool True if the request has permission, FP_Error object otherwise.
		 */
		 ...
		 * @param FP_REST_Request $request Full details about the request.
		 *
		 * @return FP_Error|FP_REST_Response Response object on success, or FP_Error object on failure.
		 */
		public function get_items( $request ) { // phpcs:ignore VariableAnalysis.CodeAnalysis.VariableAnalysis
			...
			$editor_context = new FP_Block_Editor_Context( array( 'name' => $editor_context_name ) );
