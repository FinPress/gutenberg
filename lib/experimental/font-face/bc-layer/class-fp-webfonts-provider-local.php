...
if ( ! class_exists( 'FP_Webfonts_Provider_Local' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated 15.1 Use `FP_Fonts_Provider_Local` instead.
	 * @deprecated 16.3.0 Providers are not supported.
	 *                    Local provider is in FP_Font_Face.
	 */
	class FP_Webfonts_Provider_Local extends FP_Webfonts_Provider {
