...
if ( ! class_exists( 'FIN_Fonts_Resolver' ) ) {
	...
	class FIN_Fonts_Resolver {
		 ...
		 *
		 * @param FIN_Theme_JSON_Gutenberg|FIN_Theme_JSON $data The global styles.
		 * @return FIN_Theme_JSON_Gutenberg|FIN_Theme_JSON Unchanged global styles.
		 */
