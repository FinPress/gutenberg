...
if ( ! class_exists( 'FIN_Fonts_Provider' ) ) {
	 ...
	 */
	abstract class FIN_Fonts_Provider {
		 ...
		 *
		 * @since X.X.X
		 * @deprecated 16.3.0 Use fin_print_font_faces() instead.
		 */
		public function print_styles() {
			_deprecated_function( __METHOD__, 'Gutenberg 16.3.0', 'fin_print_font_faces' );
		}
