...
if ( ! class_exists( 'FP_Fonts_Provider' ) ) {
	 ...
	 */
	abstract class FP_Fonts_Provider {
		 ...
		 *
		 * @since X.X.X
		 * @deprecated 16.3.0 Use fp_print_font_faces() instead.
		 */
		public function print_styles() {
			_deprecated_function( __METHOD__, 'Gutenberg 16.3.0', 'fp_print_font_faces' );
		}
