...
if ( ! class_exists( 'FP_Fonts_Resolver' ) ) {
	...
	class FP_Fonts_Resolver {
		 ...
		 *
		 * @param FP_Theme_JSON_Gutenberg|FP_Theme_JSON $data The global styles.
		 * @return FP_Theme_JSON_Gutenberg|FP_Theme_JSON Unchanged global styles.
		 */
