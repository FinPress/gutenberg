...
if ( ! class_exists( 'FP_Webfonts_Provider' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated 15.1 Use `FP_Fonts_Provider` instead.
	 * @deprecated 16.3.0 Custom providers are not supported.
	 */
	abstract class FP_Webfonts_Provider extends FP_Fonts_Provider {

		/**
		 * Fonts to be processed.
		 *
		 * @since X.X.X
		 * @deprecated 15.1 Use FP_Fonts_Provider::$fonts property instead.
		 * @deprecated 16.3.0
		 *
		 * @var array[]
		 */
		 ...
		 *
		 * @since X.X.X
		 * @deprecated GB 15.1 Use FP_Fonts_Provider::set_fonts() instead.
