...
if ( ! class_exists( 'FIN_Webfonts_Provider_Local' ) ) {
	 ...
	 *
	 * @since X.X.X
	 * @deprecated 15.1 Use `FIN_Fonts_Provider_Local` instead.
	 * @deprecated 16.3.0 Providers are not supported.
	 *                    Local provider is in FIN_Font_Face.
	 */
	class FIN_Webfonts_Provider_Local extends FIN_Webfonts_Provider {
