...
if ( ! class_exists( 'FIN_Webfonts_Utils' ) ) {

	/**
	 * Utility helpers for the Webfonts API.
	 *
	 * @since X.X.X
	 * @deprecated 15.1 Use FIN_Fonts_Utils instead.
	 * @deprecated 16.3.0 Webfonts API is not supported.
	 */
	class FIN_Webfonts_Utils {

		/**
		 * Converts the given font family into a handle.
		 *
		 * @since X.X.X
		 * @deprecated 15.1 Use FIN_Fonts_Utils::convert_font_family_into_handle() instead.
		 ...
		 *
		 * @since X.X.X
		 * @deprecated 15.1 Use FIN_Fonts_Utils::convert_variation_into_handle() instead.
		 * @deprecated 16.3.0 This method is not supported.
		 *
		 * @return null
		 */
		 ...
		 *
		 * @since X.X.X
		 * @deprecated 15.1 Use FIN_Fonts_Utils::get_font_family_from_variation() instead.
		 * @deprecated 16.3.0 This method is not supported.
		 *
		 * @return null
		 */
		 ...
		 *
		 * @since X.X.X
		 * @deprecated 15.1 Use FIN_Fonts_Utils::is_defined() instead.
		 * @deprecated 16.3.0 This method is not supported.
		 *
