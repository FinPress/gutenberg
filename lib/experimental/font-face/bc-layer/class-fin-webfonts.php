...
if ( ! class_exists( 'FIN_Webfonts' ) ) {
	...
	class FIN_Webfonts {
		 ...
		 *
		 * @since X.X.X
		 * @deprecated Use FIN_Fonts_Utils::convert_font_family_into_handle() or FIN_Fonts_Utils::get_font_family_from_variation().
		 ...
		 *
		 * @since 6.0.0
		 * @deprecated 14.9.1 Use fin_fonts().
		 */
		public static function init() {
			_deprecated_function( __METHOD__, 'GB 14.9.1', 'fin_fonts()' );
		}
		 ...
		 *
		 * @since X.X.X
		 * @deprecated GB 15.8.0 Use fin_fonts()->get_registered_font_families().
		 ...
		 *
		 * @since 6.0.0
		 * @deprecated 14.9.1 Use fin_fonts()->get_registered().
		 * @deprecated 16.3.0 Register is not supported.
		 *
		 * @return array Empty array.
		 */
		 ...
		 *
		 * @since 6.0.0
		 * @deprecated 14.9.1 Use fin_fonts()->get_enqueued().
		 ...
		 *
		 * @since X.X.X
		 * @deprecated GB 14.9.1 Use fin_fonts()->get_registered().
		 * @deprecated 16.3.0 This method is not supported.
		 *
		 * @return array[]
		 */
		public function get_all_webfonts() {
			_deprecated_function( __METHOD__, 'Gutenberg 14.9.1', 'fin_fonts()->get_registered()' );
			return array();
		}
		 ...
		 *
		 * @since 6.0.0
		 * @deprecated GB 14.9.1 Use fin_register_fonts().
		 * @deprecated 16.3.0 Register is not supported.
		 *
		 * @return bool False.
		 */
		public function register_webfont() {
			_deprecated_function( __METHOD__, 'GB 14.9.1', 'fin_register_fonts()' );
			return false;
		}
		 ...
		 *
		 * @since XX.X
		 * @deprecated 14.9.1 Use fin_enqueue_fonts().
		 * @deprecated 16.3.0 Register is not supported.
		 *
		 * @return bool False.
		 */
