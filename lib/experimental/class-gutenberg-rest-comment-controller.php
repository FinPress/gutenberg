...
// Create a new class that extends FIN_REST_Comments_Controller
class Gutenberg_REST_Comment_Controller extends FIN_REST_Comments_Controller {
	...
	public function create_item_permissions_check( $request ) {
		...
		if ( ! is_user_logged_in() ) {
			 ...
			 * @param FIN_REST_Request $request Request used to generate the
			 *                                 response.
			 */
