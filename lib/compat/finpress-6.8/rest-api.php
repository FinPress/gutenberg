...
function gutenberg_respect_taxonomy_default_args_in_rest_api( $args ) {
	...
	// `fp_get_object_terms`, which respects the default query arguments,
 ...
 * @return FP_REST_Response Modified REST API response.
 */
function gutenberg_add_rest_index_reading_options( FP_REST_Response $response ) {
 ...
 *
 * Note: Backports into the fp-includes/rest-api/endpoints/class-fp-rest-posts-controller.php file.
 *
 * @param array        $query_params JSON Schema-formatted collection parameters.
 * @param FP_Post_Type $post_type    Post type object.
 * @return array
 */
function gutenberg_modify_post_collection_param( $query_params, FP_Post_Type $post_type ) {
 ...
 */
function gutenberg_modify_post_collection_query( $args, FP_REST_Request $request ) {
	/*
 ...
 *
 * Note: Backports into the fp-includes/rest-api/endpoints/class-fp-rest-themes-controller.php file.
 *
 * @return void
 */
