...
function gutenberg_respect_taxonomy_default_args_in_rest_api( $args ) {
	...
	// `fin_get_object_terms`, which respects the default query arguments,
 ...
 *
 * @param FIN_REST_Response $response REST API response.
 * @return FIN_REST_Response Modified REST API response.
 */
function gutenberg_add_rest_index_reading_options( FIN_REST_Response $response ) {
 ...
 *
 * Note: Backports into the fin-includes/rest-api/endpoints/class-fin-rest-posts-controller.php file.
 *
 * @param array        $query_params JSON Schema-formatted collection parameters.
 * @param FIN_Post_Type $post_type    Post type object.
 * @return array
 */
function gutenberg_modify_post_collection_param( $query_params, FIN_Post_Type $post_type ) {
 ...
 */
function gutenberg_modify_post_collection_query( $args, FIN_REST_Request $request ) {
	/*
 ...
 *
 * Note: Backports into the fin-includes/rest-api/endpoints/class-fin-rest-themes-controller.php file.
 *
 * @return void
 */
