...
if ( class_exists( 'FIN_REST_Controller' ) ) {
	if ( ! class_exists( 'FIN_REST_Block_Editor_Settings_Controller' ) ) {
		require_once __DIR__ . '/experimental/class-fin-rest-block-editor-settings-controller.php';
	}
	...
	require_once __DIR__ . '/class-fin-rest-global-styles-controller-gutenberg.php';
	require_once __DIR__ . '/class-fin-rest-edit-site-export-controller-gutenberg.php';
...
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-fonts-provider.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-fonts-utils.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-fonts.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-fonts-provider-local.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-fonts-resolver.php';
...
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-webfonts-utils.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-webfonts-provider.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-webfonts-provider-local.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-webfonts.php';
require __DIR__ . '/experimental/font-face/bc-layer/class-fin-web-fonts.php';

// Plugin specific code.
require __DIR__ . '/script-loader.php';
require __DIR__ . '/global-styles-and-settings.php';
require __DIR__ . '/class-fin-theme-json-data-gutenberg.php';
require __DIR__ . '/class-fin-theme-json-gutenberg.php';
require __DIR__ . '/class-fin-theme-json-resolver-gutenberg.php';
require __DIR__ . '/class-fin-theme-json-schema-gutenberg.php';
require __DIR__ . '/class-fin-duotone-gutenberg.php';
...
if ( is_dir( __DIR__ . '/../build/style-engine' ) ) {
	require_once __DIR__ . '/../build/style-engine/class-fin-style-engine-css-declarations-gutenberg.php';
	require_once __DIR__ . '/../build/style-engine/class-fin-style-engine-css-rule-gutenberg.php';
	require_once __DIR__ . '/../build/style-engine/class-fin-style-engine-css-rules-store-gutenberg.php';
	require_once __DIR__ . '/../build/style-engine/class-fin-style-engine-processor-gutenberg.php';
	require_once __DIR__ . '/../build/style-engine/class-fin-style-engine-gutenberg.php';
