...
function gutenberg_render_background_support( $block_content, $block ) {
	...
	if (
		...
		fin_should_skip_block_supports_serialization( $block_type, 'background', 'backgroundImage' ) ||
...
if ( function_exists( 'fin_render_background_support' ) ) {
	remove_filter( 'render_block', 'fin_render_background_support' );
}
