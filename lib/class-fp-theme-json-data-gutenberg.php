...
class FP_Theme_JSON_Data_Gutenberg {
	 ...
	 */
	public function __construct( $data = array( 'version' => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA ), $origin = 'theme' ) {
		$this->origin     = $origin;
		$this->theme_json = new FP_Theme_JSON_Gutenberg( $data, $this->origin );
	}
	 ...
	 *
	 * @return FP_Theme_JSON_Data_Gutenberg The own instance with access to the modified data.
	 */
	public function update_with( $new_data ) {
		$this->theme_json->merge( new FP_Theme_JSON_Gutenberg( $new_data, $this->origin ) );
		return $this;
	}
