...
/**
 * Test FIN_Theme_JSON_Gutenberg class.
 *
 * @package Gutenberg
 *
 * @covers FIN_Theme_JSON_Gutenberg
 */

class FIN_Theme_JSON_Gutenberg_Test extends FIN_UnitTestCase {
	/**
	 * Administrator ID.
	 *
	 * @var int
	 ...
	 * @var string
	 */
	private static $base_styles = ':where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
	...
	public function test_get_settings() {
		$theme_json = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'       => array(
						'custom' => false,
					),
	...
	public function test_get_settings_presets_are_keyed_by_origin() {
		$default_origin = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'       => array(
		...
		$no_origin      = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'       => array(
	...
	public function test_get_stylesheet() {
		...
		$variables = ':root{--fin--preset--color--grey: grey;--fin--preset--gradient--custom-gradient: linear-gradient(135deg,rgba(0,0,0) 0%,rgb(0,0,0) 100%);--fin--preset--font-size--small: 14px;--fin--preset--font-size--big: 41px;--fin--preset--font-family--arial: Arial, serif;}.fin-block-group{--fin--custom--base-font: 16;--fin--custom--line-height--small: 1.2;--fin--custom--line-height--medium: 1.4;--fin--custom--line-height--large: 1.8;}';
		$styles    = static::$base_styles . 'body{color: var(--fin--preset--color--grey);}a:where(:not(.fin-element-button)){background-color: #333;color: #111;}:root :where(.fin-element-button, .fin-block-button__link){box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.66);}:root :where(.fin-block-cover){min-height: unset;aspect-ratio: 16/9;}:root :where(.fin-block-group){background: var(--fin--preset--gradient--custom-gradient);border-radius: 10px;min-height: 50vh;padding: 24px;}:root :where(.fin-block-group a:where(:not(.fin-element-button))){color: #111;}:root :where(.fin-block-heading){color: #123456;}:root :where(.fin-block-heading a:where(:not(.fin-element-button))){background-color: #333;color: #111;font-size: 60px;}:root :where(.fin-block-media-text){text-align: center;}:root :where(.fin-block-post-date){color: #123456;}:root :where(.fin-block-post-date a:where(:not(.fin-element-button))){background-color: #777;color: #555;}:root :where(.fin-block-post-excerpt){column-count: 2;}:root :where(.fin-block-image){margin-bottom: 30px;}:root :where(.fin-block-image img, .fin-block-image .fin-block-image__crop-area, .fin-block-image .components-placeholder){border-top-left-radius: 10px;border-bottom-right-radius: 1em;}:root :where(.fin-block-image img, .fin-block-image .components-placeholder){filter: var(--fin--preset--duotone--custom-duotone);}';
		$presets   = '.has-grey-color{color: var(--fin--preset--color--grey) !important;}.has-grey-background-color{background-color: var(--fin--preset--color--grey) !important;}.has-grey-border-color{border-color: var(--fin--preset--color--grey) !important;}.has-custom-gradient-gradient-background{background: var(--fin--preset--gradient--custom-gradient) !important;}.has-small-font-size{font-size: var(--fin--preset--font-size--small) !important;}.has-big-font-size{font-size: var(--fin--preset--font-size--big) !important;}.has-arial-font-family{font-family: var(--fin--preset--font-family--arial) !important;}';
	...
	public function test_get_styles_for_block_support_for_shorthand_and_longhand_values() {
		...
		$group_node = array(
			...
			'selector'  => '.fin-block-group',
			'selectors' => array(
				'root' => '.fin-block-group',
			),
		);
		$image_node = array(
			'name'      => 'core/image',
			...
			'selectors' => array(
				'root'   => '.fin-block-image',
				'border' => '.fin-block-image img, .fin-block-image .fin-block-image__crop-area, .fin-block-image .components-placeholder',
			),
		);

		$group_styles = ':root :where(.fin-block-group){border-radius: 10px;margin: 1em;padding: 24px;}';
		$image_styles = ':root :where(.fin-block-image){margin-bottom: 30px;padding-top: 15px;}:root :where(.fin-block-image img, .fin-block-image .fin-block-image__crop-area, .fin-block-image .components-placeholder){border-top-left-radius: 10px;border-bottom-right-radius: 1em;}';
	...
	public function test_get_stylesheet_skips_disabled_protected_properties() {
		...
		$expected = static::$base_styles . ':where(.fin-block-columns.is-layout-flex){gap: 2em;}:where(.fin-block-columns.is-layout-grid){gap: 2em;}';
	...
	public function test_get_stylesheet_renders_enabled_protected_properties() {
		...
		$expected = ':where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fin-site-blocks) > * { margin-block-start: 1em; margin-block-end: 0; }:where(.fin-site-blocks) > :first-child { margin-block-start: 0; }:where(.fin-site-blocks) > :last-child { margin-block-end: 0; }:root { --fin--style--block-gap: 1em; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1em;}:root :where(.is-layout-grid){gap: 1em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet() );
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ) ) );
	}
	...
	public function test_get_stylesheet_preset_classes_work_with_compounded_selectors() {
		...
		$this->assertSameCSS(
			'.fin-block-heading.has-white-color{color: var(--fin--preset--color--white) !important;}.fin-block-heading.has-white-background-color{background-color: var(--fin--preset--color--white) !important;}.fin-block-heading.has-white-border-color{border-color: var(--fin--preset--color--white) !important;}',
	...
	public function test_get_stylesheet_preset_rules_come_after_block_rules() {
		...
		$styles    = ':root :where(.fin-block-group){color: red;}';
		$presets   = '.fin-block-group.has-grey-color{color: var(--fin--preset--color--grey) !important;}.fin-block-group.has-grey-background-color{background-color: var(--fin--preset--color--grey) !important;}.fin-block-group.has-grey-border-color{border-color: var(--fin--preset--color--grey) !important;}';
		$variables = '.fin-block-group{--fin--preset--color--grey: grey;}';
	...
	public function test_get_stylesheet_generates_proper_classes_and_css_vars_from_slugs() {
		...
		$this->assertSameCSS(
			'.has-grey-color{color: var(--fin--preset--color--grey) !important;}.has-dark-grey-color{color: var(--fin--preset--color--dark-grey) !important;}.has-light-grey-color{color: var(--fin--preset--color--light-grey) !important;}.has-white-2-black-color{color: var(--fin--preset--color--white-2-black) !important;}.has-grey-background-color{background-color: var(--fin--preset--color--grey) !important;}.has-dark-grey-background-color{background-color: var(--fin--preset--color--dark-grey) !important;}.has-light-grey-background-color{background-color: var(--fin--preset--color--light-grey) !important;}.has-white-2-black-background-color{background-color: var(--fin--preset--color--white-2-black) !important;}.has-grey-border-color{border-color: var(--fin--preset--color--grey) !important;}.has-dark-grey-border-color{border-color: var(--fin--preset--color--dark-grey) !important;}.has-light-grey-border-color{border-color: var(--fin--preset--color--light-grey) !important;}.has-white-2-black-border-color{border-color: var(--fin--preset--color--white-2-black) !important;}',
			$theme_json->get_stylesheet( array( 'presets' ) )
		);
		$this->assertSameCSS(
			':root{--fin--preset--color--grey: grey;--fin--preset--color--dark-grey: grey;--fin--preset--color--light-grey: grey;--fin--preset--color--white-2-black: grey;--fin--custom--white-2-black: value;}',
	...
	public function test_get_styles_for_block_handles_whitelisted_element_pseudo_selectors() {
		...
		$link_node  = array(
			...
			'selector' => 'a:where(:not(.fin-element-button))',
		);
		$hover_node = array(
			'path'     => array( 'styles', 'elements', 'link' ),
			'selector' => 'a:where(:not(.fin-element-button)):hover',
		);
		$focus_node = array(
			'path'     => array( 'styles', 'elements', 'link' ),
			'selector' => 'a:where(:not(.fin-element-button)):focus',
		);

		$link_style  = 'a:where(:not(.fin-element-button)){background-color: red;color: green;}';
		$hover_style = ':root :where(a:where(:not(.fin-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}';
		$focus_style = ':root :where(a:where(:not(.fin-element-button)):focus){background-color: black;color: yellow;}';
	...
	public function test_get_stylesheet_handles_only_pseudo_selector_rules_for_given_property() {
		...
		$expected = ':root :where(a:where(:not(.fin-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}:root :where(a:where(:not(.fin-element-button)):focus){background-color: black;color: yellow;}';
	...
	public function test_get_stylesheet_ignores_non_whitelisted_pseudo_selectors() {
		...
		$expected = 'a:where(:not(.fin-element-button)){background-color: red;color: green;}:root :where(a:where(:not(.fin-element-button)):hover){background-color: green;color: red;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	...
	public function test_get_stylesheet_handles_priority_of_elements_vs_block_elements_pseudo_selectors() {
		...
		$expected = ':root :where(.fin-block-group a:where(:not(.fin-element-button))){background-color: red;color: green;}:root :where(.fin-block-group a:where(:not(.fin-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}:root :where(.fin-block-group a:where(:not(.fin-element-button)):focus){background-color: black;color: yellow;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_stylesheet_with_deprecated_feature_level_selectors() {
		...
		$base_styles   = ':root{--fin--preset--color--green: green;}';
		$block_styles  = ':root :where(.fin-block-calendar){font-size: 3em;}:root :where(.fin-block-calendar table, .fin-block-calendar th){color: green;}';
		$preset_styles = '.has-green-color{color: var(--fin--preset--color--green) !important;}.has-green-background-color{background-color: var(--fin--preset--color--green) !important;}.has-green-border-color{border-color: var(--fin--preset--color--green) !important;}';
	...
	public function test_get_stylesheet_with_block_json_selectors() {
		...
		$expected = ':root :where(.fin-block-image img, .fin-block-image .fin-block-image__crop-area, .fin-block-image .components-placeholder){border-radius: 374px;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles', 'presets', 'variables' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_stylesheet_generates_layout_styles() {
		...
		$this->assertSameCSS(
			':root { --fin--style--global--content-size: 640px;--fin--style--global--wide-size: 1200px; }:where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fin-site-blocks) > * { margin-block-start: 1em; margin-block-end: 0; }:where(.fin-site-blocks) > :first-child { margin-block-start: 0; }:where(.fin-site-blocks) > :last-child { margin-block-end: 0; }:root { --fin--style--block-gap: 1em; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1em;}:root :where(.is-layout-grid){gap: 1em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fin--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fin--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}',
	...
	public function test_get_stylesheet_generates_layout_styles_with_spacing_presets() {
		...
		// Results also include root site blocks styles.
		$this->assertSameCSS(
			':root { --fin--style--global--content-size: 640px;--fin--style--global--wide-size: 1200px; }:where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fin-site-blocks) > * { margin-block-start: var(--fin--preset--spacing--60); margin-block-end: 0; }:where(.fin-site-blocks) > :first-child { margin-block-start: 0; }:where(.fin-site-blocks) > :last-child { margin-block-end: 0; }:root { --fin--style--block-gap: var(--fin--preset--spacing--60); }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: var(--fin--preset--spacing--60);margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: var(--fin--preset--spacing--60);margin-block-end: 0;}:root :where(.is-layout-flex){gap: var(--fin--preset--spacing--60);}:root :where(.is-layout-grid){gap: var(--fin--preset--spacing--60);}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fin--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fin--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}',
			$theme_json->get_stylesheet( array( 'styles' ) )
		);
	}
	...
	public function test_get_stylesheet_generates_base_fallback_gap_layout_styles() {
		...
		$this->assertSameCSS(
			':where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}:where(.fin-block-columns.is-layout-flex){gap: 2em;}:where(.fin-block-columns.is-layout-grid){gap: 2em;}:where(.fin-block-post-template.is-layout-flex){gap: 1.25em;}:where(.fin-block-post-template.is-layout-grid){gap: 1.25em;}',
			$stylesheet
		);
	}
	...
	public function test_get_stylesheet_generates_valid_block_gap_values_and_skips_null_or_false_values() {
		...
		$this->assertSameCSS(
			':root { --fin--style--global--content-size: 640px;--fin--style--global--wide-size: 1200px; }:where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fin-site-blocks) > * { margin-block-start: 1rem; margin-block-end: 0; }:where(.fin-site-blocks) > :first-child { margin-block-start: 0; }:where(.fin-site-blocks) > :last-child { margin-block-end: 0; }:root { --fin--style--block-gap: 1rem; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1rem;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1rem;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1rem;}:root :where(.is-layout-grid){gap: 1rem;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fin--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fin--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}:root :where(.fin-block-post-content){color: gray;}:root :where(.fin-block-social-links-is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.fin-block-social-links-is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.fin-block-social-links-is-layout-flow) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fin-block-social-links-is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.fin-block-social-links-is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.fin-block-social-links-is-layout-constrained) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fin-block-social-links-is-layout-flex){gap: 0;}:root :where(.fin-block-social-links-is-layout-grid){gap: 0;}:root :where(.fin-block-buttons-is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.fin-block-buttons-is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.fin-block-buttons-is-layout-flow) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fin-block-buttons-is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.fin-block-buttons-is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.fin-block-buttons-is-layout-constrained) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fin-block-buttons-is-layout-flex){gap: 0;}:root :where(.fin-block-buttons-is-layout-grid){gap: 0;}',
	...
	public function test_get_stylesheet_returns_outline_styles() {
		...
		$expected = ':root :where(.fin-element-button, .fin-block-button__link){outline-color: red;outline-offset: 3px;outline-style: dashed;outline-width: 3px;}:root :where(.fin-element-button:hover, .fin-block-button__link:hover){outline-color: blue;outline-offset: 3px;outline-style: solid;outline-width: 3px;}';
	...
	public function test_get_stylesheet_generates_fluid_typography_values() {
		...
		$this->assertSameCSS(
			':root{--fin--preset--font-size--pickles: clamp(14px, 0.875rem + ((1vw - 3.2px) * 0.156), 16px);--fin--preset--font-size--toast: clamp(14.642px, 0.915rem + ((1vw - 3.2px) * 0.575), 22px);}body{font-size: clamp(0.875em, 0.875rem + ((1vw - 0.2em) * 0.156), 1em);}h1{font-size: clamp(50.171px, 3.136rem + ((1vw - 3.2px) * 3.893), 100px);}:root :where(.fin-block-test-clamp-me){font-size: clamp(27.894px, 1.743rem + ((1vw - 3.2px) * 1.571), 48px);}.has-pickles-font-size{font-size: var(--fin--preset--font-size--pickles) !important;}.has-toast-font-size{font-size: var(--fin--preset--font-size--toast) !important;}',
	...
	public function test_allow_indirect_properties() {
		$actual = FIN_Theme_JSON_Gutenberg::remove_insecure_properties(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'   => array(
					'blocks'  => array(
	...
	public function test_merge_incoming_data() {
		...
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $add_new_block ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $add_key_in_settings ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $update_key_in_settings ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $add_styles ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $add_key_in_styles ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $add_invalid_context ) );
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $update_presets ) );
	...
	public function test_merge_incoming_data_color_presets_with_same_slugs_as_default_are_removed() {
		$defaults = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'  => array(
		...
		$theme    = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'  => array(
	...
	public function test_merge_incoming_background_styles() {
		...
		$theme_json->merge( new FIN_Theme_JSON_Gutenberg( $update_background_image_styles ) );
		$actual = $theme_json->get_raw_data();
	...
	public function test_remove_insecure_properties_removes_unsafe_styles() {
		...
		$expected = array(
			...
			'styles'  => array(
				'color'    => array(
					'text' => 'var(--fin--preset--color--dark-red)',
				),
				'elements' => array(
					'link' => array(
						'color' => array(
							'text'       => 'var(--fin--preset--color--dark-pink)',
							'background' => 'var(--fin--preset--color--dark-red)',
						),
					),
				),
				'blocks'   => array(
					'core/image' => array(
						'filter' => array(
							'duotone' => 'var(--fin--preset--duotone--blue-red)',
						),
					),
					'core/group' => array(
						'color'    => array(
							'text' => 'var(--fin--preset--color--dark-gray)',
						),
						'elements' => array(
							'link' => array(
								'color' => array(
	...
	/**
	 * @covers FIN_Theme_JSON_Gutenberg::remove_insecure_properties
	 */
	...
	public function test_get_from_editor_settings() {
		...
		$actual = FIN_Theme_JSON_Gutenberg::get_from_editor_settings( $input );
	...
	public function test_get_editor_settings_blank() {
		...
		$actual   = FIN_Theme_JSON_Gutenberg::get_from_editor_settings( array() );
	...
	public function test_get_editor_settings_custom_units_can_be_disabled() {
		...
		$actual = FIN_Theme_JSON_Gutenberg::get_from_editor_settings( get_classic_theme_supports_block_editor_settings() );
	...
	public function test_export_data() {
		...
		$user  = new FIN_Theme_JSON_Gutenberg(
			array(
				'version'  => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color' => array(
	...
	public function test_export_data_deals_with_empty_data() {
		$theme    = new FIN_Theme_JSON_Gutenberg(
			array( 'version' => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA ),
			'theme'
		);
		$actual   = $theme->get_data();
		$expected = array( 'version' => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA );
		$this->assertEqualSetsWithIndex( $expected, $actual );
	}
	...
	public function test_get_element_class_name_button() {
		$expected = 'fin-element-button';
		$actual   = FIN_Theme_JSON_Gutenberg::get_element_class_name( 'button' );
	...
	public function test_get_element_class_name_invalid() {
		$expected = '';
		$actual   = FIN_Theme_JSON_Gutenberg::get_element_class_name( 'unknown-element' );
	...
	public function test_get_property_value_valid() {
		...
		$expected = 'body{background-color: #ffffff;color: #000000;}:root :where(.fin-element-button, .fin-block-button__link){background-color: #000000;color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	 ...
	 *
	 * @covers FIN_Theme_JSON_Gutenberg::get_property_value
	 *
	...
	public function test_get_property_value_should_return_string_for_invalid_paths_or_null_values( $styles, $path ) {
		$reflection_class = new ReflectionClass( FIN_Theme_JSON_Gutenberg::class );
	...
	public function test_get_property_value_loop() {
		...
		$expected = 'body{background-color: #ffffff;}:root :where(.fin-element-button, .fin-block-button__link){color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_property_value_recursion() {
		...
		$expected = 'body{background-color: #ffffff;color: #ffffff;}:root :where(.fin-element-button, .fin-block-button__link){color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_styles_for_block_with_padding_aware_alignments() {
		...
		$expected    = ':where(body) { margin: 0; }.fin-site-blocks { padding-top: var(--fin--style--root--padding-top); padding-bottom: var(--fin--style--root--padding-bottom); }.has-global-padding { padding-right: var(--fin--style--root--padding-right); padding-left: var(--fin--style--root--padding-left); }.has-global-padding > .alignfull { margin-right: calc(var(--fin--style--root--padding-right) * -1); margin-left: calc(var(--fin--style--root--padding-left) * -1); }.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.fin-block-block, .alignfull)) { padding-right: 0; padding-left: 0; }.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.fin-block-block, .alignfull)) > .alignfull { margin-left: 0; margin-right: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}body{--fin--style--root--padding-top: 10px;--fin--style--root--padding-right: 12px;--fin--style--root--padding-bottom: 10px;--fin--style--root--padding-left: 12px;}';
		$root_rules  = $theme_json->get_root_layout_rules( FIN_Theme_JSON_Gutenberg::ROOT_BLOCK_SELECTOR, $metadata );
	...
	public function test_get_styles_with_content_width() {
		...
		$expected = ':root { --fin--style--global--content-size: 800px;--fin--style--global--wide-size: 1000px; }:where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fin--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fin--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_root_layout_rules( FIN_Theme_JSON::ROOT_BLOCK_SELECTOR, $metadata ) );
	}
	...
	public function test_get_styles_with_appearance_tools() {
		...
		$expected = ':where(body) { margin: 0; }.fin-site-blocks > .alignleft { float: left; margin-right: 2em; }.fin-site-blocks > .alignright { float: right; margin-left: 2em; }.fin-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fin-site-blocks) > * { margin-block-start: ; margin-block-end: 0; }:where(.fin-site-blocks) > :first-child { margin-block-start: 0; }:where(.fin-site-blocks) > :last-child { margin-block-end: 0; }:root { --fin--style--block-gap: ; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1;}:root :where(.is-layout-grid){gap: 1;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_root_layout_rules( FIN_Theme_JSON_Gutenberg::ROOT_BLOCK_SELECTOR, $metadata ) );
	}
	...
	public function test_unwraps_block_style_variations() {
		...
		$input = new FIN_Theme_JSON_Gutenberg(
			array(
				'version' => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'  => array(
					'variations' => array(
	...
	public function data_get_styles_for_block_with_style_variations() {
		$plain = array(
			'metadata' => array(
				...
				'selector' => '.is-style-plain.fin-block-quote',
			),
			'styles'   => ':root :where(.is-style-plain.fin-block-quote){background-color: hotpink;}',
		);
	...
	public function test_get_styles_for_block_with_style_variations_and_custom_selectors() {
		register_block_type(
			...
			array(
				...
				'selectors'   => array(
					'root'  => '.milk',
					'color' => '.fin-block-test-milk .liquid, .fin-block-test-milk:not(.spoiled), .fin-block-test-milk.in-bottle',
				),
			)
		);
		...
		$metadata = array(
			...
			'variations' => array(
				'chocolate' => array(
					...
					'selector' => '.is-style-chocolate.fin-block-test-milk',
				),
			),
		);

		$actual_styles    = $theme_json->get_styles_for_block( $metadata );
		$default_styles   = ':root :where(.fin-block-test-milk .liquid, .fin-block-test-milk:not(.spoiled), .fin-block-test-milk.in-bottle){background-color: white;}';
		$variation_styles = ':root :where(.is-style-chocolate.fin-block-test-milk .liquid,.is-style-chocolate.fin-block-test-milk:not(.spoiled),.is-style-chocolate.fin-block-test-milk.in-bottle){background-color: #35281E;}';
	...
	public function test_block_style_variations() {
		fin_set_current_user( static::$administrator_id );
		...
		$actual = FIN_Theme_JSON_Gutenberg::remove_insecure_properties( $expected );
	...
	public function test_block_style_variations_with_invalid_properties() {
		...
		$actual = FIN_Theme_JSON_Gutenberg::remove_insecure_properties( $partially_invalid_variation );
	...
	public function test_block_style_variations_with_invalid_inner_block_or_element_styles() {
		...
		$actual = FIN_Theme_JSON_Gutenberg::remove_insecure_properties( $input );
	...
	public function test_set_spacing_sizes( $spacing_scale, $expected_output ) {
		...
		$this->assertSame( $expected_output, _fin_array_get( $theme_json->get_raw_data(), array( 'settings', 'spacing', 'spacingSizes', 'default' ) ) );
	}
	...
	public function data_update_separator_declarations() {
		return array(
			...
			'only background'                      => array(
				...
				'expected_output' => ':root :where(.fin-block-separator){background-color: blue;color: blue;}',
			),
			...
			'background and text, no border-color' => array(
				...
				'expected_output' => ':root :where(.fin-block-separator){background-color: blue;color: red;}',
			),
			...
			'only text'                            => array(
				...
				'expected_output' => ':root :where(.fin-block-separator){color: red;}',
			),
			...
			'background, text, and border-color'   => array(
				...
				'expected_output' => ':root :where(.fin-block-separator){background-color: blue;border-color: pink;color: red;}',
			),
			...
			'background, and border-color'         => array(
				...
				'expected_output' => ':root :where(.fin-block-separator){background-color: blue;border-color: pink;}',
			),
		);
	}
	...
	public function test_shadow_preset_styles() {
		...
		$expected_styles = ':root{--fin--preset--shadow--natural: 5px 5px 5px 0 black;--fin--preset--shadow--sharp: 5px 5px black;}';
	...
	public function test_get_shadow_styles_for_blocks() {
		$theme_json = new FIN_Theme_JSON_Gutenberg(
			array(
				...
				'styles'   => array(
					'blocks'   => array(
						'core/paragraph' => array(
							'shadow' => 'var(--fin--preset--shadow--natural)',
						),
					),
					'elements' => array(
						'button' => array(
		...
		$variable_styles = ':root{--fin--preset--shadow--natural: 5px 5px 0 0 black;}';
		$element_styles  = 'a:where(:not(.fin-element-button)){box-shadow: var(--fin--preset--shadow--natural);}:root :where(.fin-element-button, .fin-block-button__link){box-shadow: var(--fin--preset--shadow--natural);}:root :where(p){box-shadow: var(--fin--preset--shadow--natural);}';
	...
	public function test_get_top_level_background_image_styles() {
		...
		$expected_styles = "html{min-height: calc(100% - var(--fin-admin--admin-bar--height, 0px));}body{background-image: url('http://example.org/image.png');background-position: center center;background-repeat: no-repeat;background-attachment: fixed;}";
		...
		$expected_styles = "html{min-height: calc(100% - var(--fin-admin--admin-bar--height, 0px));}body{background-image: url('http://example.org/image.png');background-position: center center;background-repeat: no-repeat;background-size: contain;background-attachment: fixed;}";
	...
	public function test_get_block_background_image_styles() {
		...
		$group_styles = ":root :where(.fin-block-group){background-image: url('http://example.org/group.png');background-position: center center;background-repeat: no-repeat;background-attachment: fixed;}";
		...
		$quote_node = array(
			...
			'selector'  => '.fin-block-quote',
			'selectors' => array(
				'root' => '.fin-block-quote',
			),
		);

		$quote_styles = ":root :where(.fin-block-quote){background-image: url('http://example.org/quote.png');background-position: 50% 50%;background-size: contain;}";
		...
		$verse_node = array(
			...
			'selector'  => '.fin-block-verse',
			'selectors' => array(
				'root' => '.fin-block-verse',
			),
		);

		$verse_styles = ":root :where(.fin-block-verse){background-image: url('http://example.org/verse.png');background-size: cover;}";
	...
	public function test_custom_css_for_user_caps( $user_property, array $expected ) {
		fin_set_current_user( static::${$user_property} );
	...
	public function test_internal_syntax_is_converted_to_css_variables() {
		$result = new FIN_Theme_JSON_Gutenberg(
			array(
				'version' => FIN_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'  => array(
					'color'    => array(
					...
					'elements' => array(
						'link' => array(
							'color' => array(
								...
								'text'       => 'var(--fin--preset--color--sec)',
							),
						),
					),
					'blocks'   => array(
						'core/post-terms' => array(
							'typography' => array( 'fontSize' => 'var(--fin--preset--font-size--small)' ),
							...
							'elements' => array(
								'link' => array(
									'color' => array(
										...
										'text'       => 'var(--fin--preset--color--s)',
									),
								),
							),
						),
						'core/quote'      => array(
							'typography' => array( 'fontSize' => 'var(--fin--preset--font-size--d)' ),
							'color'      => array( 'background' => 'var:preset|color|d' ),
							'variations' => array(
								'plain' => array(
									'typography' => array( 'fontSize' => 'var(--fin--preset--font-size--s)' ),
		...
		$this->assertEquals( 'var(--fin--preset--color--primary)', $styles['color']['background'], 'Top level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fin--preset--color--secondary)', $styles['color']['text'], 'Top level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fin--preset--color--pri)', $styles['elements']['link']['color']['background'], 'Element top level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fin--preset--color--sec)', $styles['elements']['link']['color']['text'], 'Element top level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fin--preset--font-size--small)', $styles['blocks']['core/post-terms']['typography']['fontSize'], 'Top block level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fin--preset--color--secondary)', $styles['blocks']['core/post-terms']['color']['background'], 'Top block level: Assert the internal variables are convert to CSS custom variables.' );

		$this->assertEquals( 'var(--fin--preset--color--p)', $styles['blocks']['core/navigation']['elements']['link']['color']['background'], 'Elements block level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fin--preset--color--s)', $styles['blocks']['core/navigation']['elements']['link']['color']['text'], 'Elements block level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fin--preset--font-size--s)', $styles['blocks']['core/quote']['variations']['plain']['typography']['fontSize'], 'Style variations: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fin--preset--color--s)', $styles['blocks']['core/quote']['variations']['plain']['color']['background'], 'Style variations: Assert the internal variables are convert to CSS custom variables.' );
	}
	 ...
	 * @ticket 58588
	 *
	 * @covers FIN_Theme_JSON_Gutenberg::resolve_variables
	 * @covers FIN_Theme_JSON_Gutenberg::convert_variables_to_value
	 */
	public function test_resolve_variables() {
			...
			array(
				...
				'styles'   => array(
					...
					'elements' => array(
						'button' => array(
							'color'      => array(
								'text' => 'var(--fin--preset--color--contrast)',
							),
							'typography' => array(
					...
					'blocks'   => array(
						...
						'core/more'            => array(
							...
							'color'      => array( 'background' => 'linear-gradient(90deg, var(--fin--preset--color--primary) 0%, var(--fin--preset--color--secondary) 35%, var(--fin--undefined--color--secondary) 100%)' ),
						),
						'core/comment-content' => array(
							'typography' => array( 'fontSize' => 'calc(var(--fin--preset--font-size--small, 12px) + 20px)' ),
							'color'      => array(
								'text'       => 'var(--fin--preset--color--primary, red)',
								'background' => 'var(--fin--preset--color--primary, var(--fin--preset--font-size--secondary))',
								'link'       => 'var(--undefined--color--primary, var(--fin--preset--font-size--secondary))',
							),
						),
						'core/comments'        => array(
							'color' => array(
								'text'       => 'var(--undefined--color--primary, var(--fin--preset--font-size--small))',
								'background' => 'var(--fin--preset--color--primary, var(--undefined--color--primary))',
							),
						),
						'core/navigation'      => array(
							'elements' => array(
						...
						'core/quote'           => array(
							'typography' => array( 'fontSize' => 'var(--fin--preset--font-size--large)' ),
							'color'      => array( 'background' => 'var(--fin--preset--color--primary)' ),
							'variations' => array(
								'plain' => array(
									'typography' => array( 'fontSize' => 'var(--fin--preset--font-size--small)' ),
									'color'      => array( 'background' => 'var(--fin--preset--color--secondary)' ),
								),
							),
						),
						...
						'core/columns'         => array(
							'spacing' => array(
								'blockGap' => 'var(--fin--preset--spacing--100)',
							),
						),
					),
				),
		...
		$this->assertEquals(
			"linear-gradient(90deg, $primary_color 0%, $secondary_color 35%, var(--fin--undefined--color--secondary) 100%)",
		...
		/*
		 * FIN_Theme_JSON_Gutenberg::resolve_variables may be called with merged data from FIN_Theme_JSON_Resolver_Gutenberg::get_merged_data()
		 * FIN_Theme_JSON_Resolver_Gutenberg::get_block_data() sets blockGap for supported blocks to `null` if the value is not defined.
		 */
	...
	public function test_get_block_style_variation_selector( $selector, $expected ) {
		$theme_json = new ReflectionClass( 'FIN_Theme_JSON_Gutenberg' );
	...
	public function data_get_block_style_variation_selector() {
		return array(
			...
			'comma separated selector' => array(
				...
				'expected' => '.fin-block.is-style-custom .inner, .fin-block.is-style-custom .alternative',
			),
			...
			':is selector'             => array(
				...
				'expected' => '.fin-block.is-style-custom:is(.outer .inner:first-child)',
			),
			':not selector'            => array(
				'selector' => '.fin-block:not(.outer .inner:first-child)',
				'expected' => '.fin-block.is-style-custom:not(.outer .inner:first-child)',
			),
			':has selector'            => array(
				'selector' => '.fin-block:has(.outer .inner:first-child)',
				'expected' => '.fin-block.is-style-custom:has(.outer .inner:first-child)',
			),
			':where selector'          => array(
				'selector' => '.fin-block:where(.outer .inner:first-child)',
				'expected' => '.fin-block.is-style-custom:where(.outer .inner:first-child)',
			),
			...
			'complex'                  => array(
				'selector' => '.fin:where(.something):is(.test:not(.nothing p)):has(div[style]) .content, .fin:where(.nothing):not(.test:is(.something div)):has(span[style]) .inner',
				'expected' => '.fin.is-style-custom:where(.something):is(.test:not(.nothing p)):has(div[style]) .content, .fin.is-style-custom:where(.nothing):not(.test:is(.something div)):has(span[style]) .inner',
			),
		);
	}
	...
	public function test_scope_style_node_selectors() {
		...
		$node = array(
			...
			'selectors' => array(
				...
				'border'     => '.fin-block-image img, .fin-block-image .fin-block-image__crop-area, .fin-block-image .components-placeholder',
				'typography' => array(
					'textDecoration' => '.fin-block-image caption',
				),
				'filter'     => array(
					'duotone' => '.fin-block-image img, .fin-block-image .components-placeholder',
				),
			),
		);
		...
		$expected = array(
			'name'      => 'core/image',
			'path'      => array( 'styles', 'blocks', 'core/image' ),
			'selector'  => '.custom-scope .fin-block-image',
			'selectors' => array(
				'root'       => '.custom-scope .fin-block-image',
				'border'     => '.custom-scope .fin-block-image img, .custom-scope .fin-block-image .fin-block-image__crop-area, .custom-scope .fin-block-image .components-placeholder',
				'typography' => array(
					'textDecoration' => '.custom-scope .fin-block-image caption',
				),
				'filter'     => array(
					'duotone' => '.custom-scope .fin-block-image img, .custom-scope .fin-block-image .components-placeholder',
				),
			),
		);
	...
	public function test_opt_in_to_block_style_variations() {
		...
		$expected = array(
			array(
				...
				'selector' => '.fin-block-button.is-style-outline .fin-block-button__link',
			),
		);
