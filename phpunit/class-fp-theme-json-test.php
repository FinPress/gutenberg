...
/**
 * Test FP_Theme_JSON_Gutenberg class.
 *
 * @package Gutenberg
 *
 * @covers FP_Theme_JSON_Gutenberg
 */

class FP_Theme_JSON_Gutenberg_Test extends FP_UnitTestCase {
	/**
	 * Administrator ID.
	 *
	 * @var int
	 ...
	 * @var string
	 */
	private static $base_styles = ':where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
	...
	public function test_get_settings() {
		$theme_json = new FP_Theme_JSON_Gutenberg(
			array(
	...
	public function test_get_settings_presets_are_keyed_by_origin() {
		$default_origin = new FP_Theme_JSON_Gutenberg(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'       => array(
		...
		$no_origin      = new FP_Theme_JSON_Gutenberg(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'       => array(
	...
	public function test_get_stylesheet() {
		...
		$variables = ':root{--fp--preset--color--grey: grey;--fp--preset--gradient--custom-gradient: linear-gradient(135deg,rgba(0,0,0) 0%,rgb(0,0,0) 100%);--fp--preset--font-size--small: 14px;--fp--preset--font-size--big: 41px;--fp--preset--font-family--arial: Arial, serif;}.fp-block-group{--fp--custom--base-font: 16;--fp--custom--line-height--small: 1.2;--fp--custom--line-height--medium: 1.4;--fp--custom--line-height--large: 1.8;}';
		$styles    = static::$base_styles . 'body{color: var(--fp--preset--color--grey);}a:where(:not(.fp-element-button)){background-color: #333;color: #111;}:root :where(.fp-element-button, .fp-block-button__link){box-shadow: 10px 10px 5px 0px rgba(0,0,0,0.66);}:root :where(.fp-block-cover){min-height: unset;aspect-ratio: 16/9;}:root :where(.fp-block-group){background: var(--fp--preset--gradient--custom-gradient);border-radius: 10px;min-height: 50vh;padding: 24px;}:root :where(.fp-block-group a:where(:not(.fp-element-button))){color: #111;}:root :where(.fp-block-heading){color: #123456;}:root :where(.fp-block-heading a:where(:not(.fp-element-button))){background-color: #333;color: #111;font-size: 60px;}:root :where(.fp-block-media-text){text-align: center;}:root :where(.fp-block-post-date){color: #123456;}:root :where(.fp-block-post-date a:where(:not(.fp-element-button))){background-color: #777;color: #555;}:root :where(.fp-block-post-excerpt){column-count: 2;}:root :where(.fp-block-image){margin-bottom: 30px;}:root :where(.fp-block-image img, .fp-block-image .fp-block-image__crop-area, .fp-block-image .components-placeholder){border-top-left-radius: 10px;border-bottom-right-radius: 1em;}:root :where(.fp-block-image img, .fp-block-image .components-placeholder){filter: var(--fp--preset--duotone--custom-duotone);}';
		$presets   = '.has-grey-color{color: var(--fp--preset--color--grey) !important;}.has-grey-background-color{background-color: var(--fp--preset--color--grey) !important;}.has-grey-border-color{border-color: var(--fp--preset--color--grey) !important;}.has-custom-gradient-gradient-background{background: var(--fp--preset--gradient--custom-gradient) !important;}.has-small-font-size{font-size: var(--fp--preset--font-size--small) !important;}.has-big-font-size{font-size: var(--fp--preset--font-size--big) !important;}.has-arial-font-family{font-family: var(--fp--preset--font-family--arial) !important;}';
	...
	public function test_get_styles_for_block_support_for_shorthand_and_longhand_values() {
		...
		$image_node = array(
			...
			'selectors' => array(
				'root'   => '.fp-block-image',
				'border' => '.fp-block-image img, .fp-block-image .fp-block-image__crop-area, .fp-block-image .components-placeholder',
			),
		);

		$group_styles = ':root :where(.fp-block-group){border-radius: 10px;margin: 1em;padding: 24px;}';
		$image_styles = ':root :where(.fp-block-image){margin-bottom: 30px;padding-top: 15px;}:root :where(.fp-block-image img, .fp-block-image .fp-block-image__crop-area, .fp-block-image .components-placeholder){border-top-left-radius: 10px;border-bottom-right-radius: 1em;}';
	...
	public function test_get_stylesheet_skips_disabled_protected_properties() {
		...
		$expected = static::$base_styles . ':where(.fp-block-columns.is-layout-flex){gap: 2em;}:where(.fp-block-columns.is-layout-grid){gap: 2em;}';
	...
	public function test_get_stylesheet_renders_enabled_protected_properties() {
		...
		$expected = ':where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fp-site-blocks) > * { margin-block-start: 1em; margin-block-end: 0; }:where(.fp-site-blocks) > :first-child { margin-block-start: 0; }:where(.fp-site-blocks) > :last-child { margin-block-end: 0; }:root { --fp--style--block-gap: 1em; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1em;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1em;}:root :where(.is-layout-grid){gap: 1em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet() );
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ) ) );
	}
	...
	public function test_get_stylesheet_preset_classes_work_with_compounded_selectors() {
		...
		$this->assertSameCSS(
			'.fp-block-heading.has-white-color{color: var(--fp--preset--color--white) !important;}.fp-block-heading.has-white-background-color{background-color: var(--fp--preset--color--white) !important;}.fp-block-heading.has-white-border-color{border-color: var(--fp--preset--color--white) !important;}',
	...
	public function test_get_stylesheet_preset_rules_come_after_block_rules() {
		...
		$styles    = ':root :where(.fp-block-group){color: red;}';
		$presets   = '.fp-block-group.has-grey-color{color: var(--fp--preset--color--grey) !important;}.fp-block-group.has-grey-background-color{background-color: var(--fp--preset--color--grey) !important;}.fp-block-group.has-grey-border-color{border-color: var(--fp--preset--color--grey) !important;}';
		$variables = '.fp-block-group{--fp--preset--color--grey: grey;}';
	...
	public function test_get_stylesheet_generates_proper_classes_and_css_vars_from_slugs() {
		...
		$this->assertSameCSS(
			'.has-grey-color{color: var(--fp--preset--color--grey) !important;}.has-dark-grey-color{color: var(--fp--preset--color--dark-grey) !important;}.has-light-grey-color{color: var(--fp--preset--color--light-grey) !important;}.has-white-2-black-color{color: var(--fp--preset--color--white-2-black) !important;}.has-grey-background-color{background-color: var(--fp--preset--color--grey) !important;}.has-dark-grey-background-color{background-color: var(--fp--preset--color--dark-grey) !important;}.has-light-grey-background-color{background-color: var(--fp--preset--color--light-grey) !important;}.has-white-2-black-background-color{background-color: var(--fp--preset--color--white-2-black) !important;}.has-grey-border-color{border-color: var(--fp--preset--color--grey) !important;}.has-dark-grey-border-color{border-color: var(--fp--preset--color--dark-grey) !important;}.has-light-grey-border-color{border-color: var(--fp--preset--color--light-grey) !important;}.has-white-2-black-border-color{border-color: var(--fp--preset--color--white-2-black) !important;}',
			$theme_json->get_stylesheet( array( 'presets' ) )
		);
		$this->assertSameCSS(
			':root{--fp--preset--color--grey: grey;--fp--preset--color--dark-grey: grey;--fp--preset--color--light-grey: grey;--fp--preset--color--white-2-black: grey;--fp--custom--white-2-black: value;}',
	...
	public function test_get_styles_for_block_handles_whitelisted_element_pseudo_selectors() {
		...
		$link_node  = array(
			...
			'selector' => 'a:where(:not(.fp-element-button))',
		);
		$hover_node = array(
			'path'     => array( 'styles', 'elements', 'link' ),
			'selector' => 'a:where(:not(.fp-element-button)):hover',
		);
		$focus_node = array(
			'path'     => array( 'styles', 'elements', 'link' ),
			'selector' => 'a:where(:not(.fp-element-button)):focus',
		);

		$link_style  = 'a:where(:not(.fp-element-button)){background-color: red;color: green;}';
		$hover_style = ':root :where(a:where(:not(.fp-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}';
		$focus_style = ':root :where(a:where(:not(.fp-element-button)):focus){background-color: black;color: yellow;}';
	...
	public function test_get_stylesheet_handles_only_pseudo_selector_rules_for_given_property() {
		...
		$expected = ':root :where(a:where(:not(.fp-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}:root :where(a:where(:not(.fp-element-button)):focus){background-color: black;color: yellow;}';
	...
	public function test_get_stylesheet_ignores_non_whitelisted_pseudo_selectors() {
		...
		$expected = 'a:where(:not(.fp-element-button)){background-color: red;color: green;}:root :where(a:where(:not(.fp-element-button)):hover){background-color: green;color: red;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	...
	public function test_get_stylesheet_handles_priority_of_elements_vs_block_elements_pseudo_selectors() {
		...
		$expected = ':root :where(.fp-block-group a:where(:not(.fp-element-button))){background-color: red;color: green;}:root :where(.fp-block-group a:where(:not(.fp-element-button)):hover){background-color: green;color: red;font-size: 10em;text-transform: uppercase;}:root :where(.fp-block-group a:where(:not(.fp-element-button)):focus){background-color: black;color: yellow;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_stylesheet_with_deprecated_feature_level_selectors() {
		...
		$base_styles   = ':root{--fp--preset--color--green: green;}';
		$block_styles  = ':root :where(.fp-block-calendar){font-size: 3em;}:root :where(.fp-block-calendar table, .fp-block-calendar th){color: green;}';
		$preset_styles = '.has-green-color{color: var(--fp--preset--color--green) !important;}.has-green-background-color{background-color: var(--fp--preset--color--green) !important;}.has-green-border-color{border-color: var(--fp--preset--color--green) !important;}';
	...
	public function test_get_stylesheet_with_block_json_selectors() {
		...
		$expected = ':root :where(.fp-block-image img, .fp-block-image .fp-block-image__crop-area, .fp-block-image .components-placeholder){border-radius: 374px;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles', 'presets', 'variables' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_stylesheet_generates_layout_styles_with_spacing_presets() {
		...
		// Results also include root site blocks styles.
		$this->assertSameCSS(
			':root { --fp--style--global--content-size: 640px;--fp--style--global--wide-size: 1200px; }:where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fp-site-blocks) > * { margin-block-start: var(--fp--preset--spacing--60); margin-block-end: 0; }:where(.fp-site-blocks) > :first-child { margin-block-start: 0; }:where(.fp-site-blocks) > :last-child { margin-block-end: 0; }:root { --fp--style--block-gap: var(--fp--preset--spacing--60); }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: var(--fp--preset--spacing--60);margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: var(--fp--preset--spacing--60);margin-block-end: 0;}:root :where(.is-layout-flex){gap: var(--fp--preset--spacing--60);}:root :where(.is-layout-grid){gap: var(--fp--preset--spacing--60);}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fp--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fp--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}',
			$theme_json->get_stylesheet( array( 'styles' ) )
		);
	}
	...
	public function test_get_stylesheet_generates_base_fallback_gap_layout_styles() {
		...
		$this->assertSameCSS(
			':where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}:where(.fp-block-columns.is-layout-flex){gap: 2em;}:where(.fp-block-columns.is-layout-grid){gap: 2em;}:where(.fp-block-post-template.is-layout-flex){gap: 1.25em;}:where(.fp-block-post-template.is-layout-grid){gap: 1.25em;}',
			$stylesheet
		);
	}
	...
	public function test_get_stylesheet_generates_valid_block_gap_values_and_skips_null_or_false_values() {
		...
		$this->assertSameCSS(
			':root { --fp--style--global--content-size: 640px;--fp--style--global--wide-size: 1200px; }:where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fp-site-blocks) > * { margin-block-start: 1rem; margin-block-end: 0; }:where(.fp-site-blocks) > :first-child { margin-block-start: 0; }:where(.fp-site-blocks) > :last-child { margin-block-end: 0; }:root { --fp--style--block-gap: 1rem; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1rem;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1rem;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1rem;}:root :where(.is-layout-grid){gap: 1rem;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fp--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fp--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}:root :where(.fp-block-post-content){color: gray;}:root :where(.fp-block-social-links-is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.fp-block-social-links-is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.fp-block-social-links-is-layout-flow) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fp-block-social-links-is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.fp-block-social-links-is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.fp-block-social-links-is-layout-constrained) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fp-block-social-links-is-layout-flex){gap: 0;}:root :where(.fp-block-social-links-is-layout-grid){gap: 0;}:root :where(.fp-block-buttons-is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.fp-block-buttons-is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.fp-block-buttons-is-layout-flow) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fp-block-buttons-is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.fp-block-buttons-is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.fp-block-buttons-is-layout-constrained) > *{margin-block-start: 0;margin-block-end: 0;}:root :where(.fp-block-buttons-is-layout-flex){gap: 0;}:root :where(.fp-block-buttons-is-layout-grid){gap: 0;}',
	...
	public function test_get_stylesheet_returns_outline_styles() {
		...
		$expected = ':root :where(.fp-element-button, .fp-block-button__link){outline-color: red;outline-offset: 3px;outline-style: dashed;outline-width: 3px;}:root :where(.fp-element-button:hover, .fp-block-button__link:hover){outline-color: blue;outline-offset: 3px;outline-style: solid;outline-width: 3px;}';
	...
	public function test_get_stylesheet_generates_fluid_typography_values() {
		...
		$this->assertSameCSS(
			':root{--fp--preset--font-size--pickles: clamp(14px, 0.875rem + ((1vw - 3.2px) * 0.156), 16px);--fp--preset--font-size--toast: clamp(14.642px, 0.915rem + ((1vw - 3.2px) * 0.575), 22px);}body{font-size: clamp(0.875em, 0.875rem + ((1vw - 0.2em) * 0.156), 1em);}h1{font-size: clamp(50.171px, 3.136rem + ((1vw - 3.2px) * 3.893), 100px);}:root :where(.fp-block-test-clamp-me){font-size: clamp(27.894px, 1.743rem + ((1vw - 3.2px) * 1.571), 48px);}.has-pickles-font-size{font-size: var(--fp--preset--font-size--pickles) !important;}.has-toast-font-size{font-size: var(--fp--preset--font-size--toast) !important;}',
	...
	public function test_allow_indirect_properties() {
		$actual = FP_Theme_JSON_Gutenberg::remove_insecure_properties(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'   => array(
					'blocks'  => array(
	...
	public function test_merge_incoming_data() {
		...
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $add_new_block ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $add_key_in_settings ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $update_key_in_settings ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $add_styles ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $add_key_in_styles ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $add_invalid_context ) );
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $update_presets ) );
	...
	public function test_merge_incoming_data_color_presets_with_same_slugs_as_default_are_removed() {
		$defaults = new FP_Theme_JSON_Gutenberg(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'  => array(
		...
		$theme    = new FP_Theme_JSON_Gutenberg(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color'  => array(
	...
	public function test_merge_incoming_background_styles() {
		...
		$theme_json->merge( new FP_Theme_JSON_Gutenberg( $update_background_image_styles ) );
		$actual = $theme_json->get_raw_data();
	...
	public function test_remove_insecure_properties_removes_unsafe_styles() {
		...
		$expected = array(
			...
			'styles'  => array(
				'color'    => array(
					'text' => 'var(--fp--preset--color--dark-red)',
				),
				'elements' => array(
					'link' => array(
						'color' => array(
							'text'       => 'var(--fp--preset--color--dark-pink)',
							'background' => 'var(--fp--preset--color--dark-red)',
						),
					),
				),
				'blocks'   => array(
					'core/image' => array(
						'filter' => array(
							'duotone' => 'var(--fp--preset--duotone--blue-red)',
						),
					),
					'core/group' => array(
						'color'    => array(
							'text' => 'var(--fp--preset--color--dark-gray)',
						),
						'elements' => array(
							'link' => array(
								'color' => array(
	...
	/**
	 * @covers FP_Theme_JSON_Gutenberg::remove_insecure_properties
	 */
	...
	public function test_get_from_editor_settings() {
		...
		$actual = FP_Theme_JSON_Gutenberg::get_from_editor_settings( $input );
	...
	public function test_get_editor_settings_blank() {
		...
		$actual   = FP_Theme_JSON_Gutenberg::get_from_editor_settings( array() );
	...
	public function test_get_editor_settings_custom_units_can_be_disabled() {
		...
		$actual = FP_Theme_JSON_Gutenberg::get_from_editor_settings( get_classic_theme_supports_block_editor_settings() );
	...
	public function test_export_data() {
		...
		$user  = new FP_Theme_JSON_Gutenberg(
			array(
				'version'  => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'settings' => array(
					'color' => array(
	...
	public function test_export_data_deals_with_empty_data() {
		$theme    = new FP_Theme_JSON_Gutenberg(
			array( 'version' => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA ),
			'theme'
		);
		$actual   = $theme->get_data();
		$expected = array( 'version' => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA );
		$this->assertEqualSetsWithIndex( $expected, $actual );
	}
	...
	public function test_get_element_class_name_button() {
		$expected = 'fp-element-button';
		$actual   = FP_Theme_JSON_Gutenberg::get_element_class_name( 'button' );
	...
	public function test_get_element_class_name_invalid() {
		$expected = '';
		$actual   = FP_Theme_JSON_Gutenberg::get_element_class_name( 'unknown-element' );
	...
	public function test_get_property_value_valid() {
		...
		$expected = 'body{background-color: #ffffff;color: #000000;}:root :where(.fp-element-button, .fp-block-button__link){background-color: #000000;color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	 ...
	 *
	 * @covers FP_Theme_JSON_Gutenberg::get_property_value
	 *
	...
	public function test_get_property_value_should_return_string_for_invalid_paths_or_null_values( $styles, $path ) {
		$reflection_class = new ReflectionClass( FP_Theme_JSON_Gutenberg::class );
	...
	public function test_get_property_value_loop() {
		...
		$expected = 'body{background-color: #ffffff;}:root :where(.fp-element-button, .fp-block-button__link){color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_property_value_recursion() {
		...
		$expected = 'body{background-color: #ffffff;color: #ffffff;}:root :where(.fp-element-button, .fp-block-button__link){color: #ffffff;}';
		$this->assertSameCSS( $expected, $theme_json->get_stylesheet( array( 'styles' ), null, array( 'skip_root_layout_styles' => true ) ) );
	}
	...
	public function test_get_styles_for_block_with_padding_aware_alignments() {
		...
		$expected    = ':where(body) { margin: 0; }.fp-site-blocks { padding-top: var(--fp--style--root--padding-top); padding-bottom: var(--fp--style--root--padding-bottom); }.has-global-padding { padding-right: var(--fp--style--root--padding-right); padding-left: var(--fp--style--root--padding-left); }.has-global-padding > .alignfull { margin-right: calc(var(--fp--style--root--padding-right) * -1); margin-left: calc(var(--fp--style--root--padding-left) * -1); }.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.fp-block-block, .alignfull)) { padding-right: 0; padding-left: 0; }.has-global-padding :where(:not(.alignfull.is-layout-flow) > .has-global-padding:not(.fp-block-block, .alignfull)) > .alignfull { margin-left: 0; margin-right: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}body{--fp--style--root--padding-top: 10px;--fp--style--root--padding-right: 12px;--fp--style--root--padding-bottom: 10px;--fp--style--root--padding-left: 12px;}';
		$root_rules  = $theme_json->get_root_layout_rules( FP_Theme_JSON_Gutenberg::ROOT_BLOCK_SELECTOR, $metadata );
	...
	public function test_get_styles_with_content_width() {
		...
		$expected = ':root { --fp--style--global--content-size: 800px;--fp--style--global--wide-size: 1000px; }:where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.is-layout-flex){gap: 0.5em;}:where(.is-layout-grid){gap: 0.5em;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){max-width: var(--fp--style--global--content-size);margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignwide{max-width: var(--fp--style--global--wide-size);}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_root_layout_rules( FP_Theme_JSON::ROOT_BLOCK_SELECTOR, $metadata ) );
	}
	...
	public function test_get_styles_with_appearance_tools() {
		...
		$expected = ':where(body) { margin: 0; }.fp-site-blocks > .alignleft { float: left; margin-right: 2em; }.fp-site-blocks > .alignright { float: right; margin-left: 2em; }.fp-site-blocks > .aligncenter { justify-content: center; margin-left: auto; margin-right: auto; }:where(.fp-site-blocks) > * { margin-block-start: ; margin-block-end: 0; }:where(.fp-site-blocks) > :first-child { margin-block-start: 0; }:where(.fp-site-blocks) > :last-child { margin-block-end: 0; }:root { --fp--style--block-gap: ; }:root :where(.is-layout-flow) > :first-child{margin-block-start: 0;}:root :where(.is-layout-flow) > :last-child{margin-block-end: 0;}:root :where(.is-layout-flow) > *{margin-block-start: 1;margin-block-end: 0;}:root :where(.is-layout-constrained) > :first-child{margin-block-start: 0;}:root :where(.is-layout-constrained) > :last-child{margin-block-end: 0;}:root :where(.is-layout-constrained) > *{margin-block-start: 1;margin-block-end: 0;}:root :where(.is-layout-flex){gap: 1;}:root :where(.is-layout-grid){gap: 1;}.is-layout-flow > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-flow > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-flow > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > .alignleft{float: left;margin-inline-start: 0;margin-inline-end: 2em;}.is-layout-constrained > .alignright{float: right;margin-inline-start: 2em;margin-inline-end: 0;}.is-layout-constrained > .aligncenter{margin-left: auto !important;margin-right: auto !important;}.is-layout-constrained > :where(:not(.alignleft):not(.alignright):not(.alignfull)){margin-left: auto !important;margin-right: auto !important;}body .is-layout-flex{display: flex;}.is-layout-flex{flex-wrap: wrap;align-items: center;}.is-layout-flex > :is(*, div){margin: 0;}body .is-layout-grid{display: grid;}.is-layout-grid > :is(*, div){margin: 0;}';
		$this->assertSameCSS( $expected, $theme_json->get_root_layout_rules( FP_Theme_JSON_Gutenberg::ROOT_BLOCK_SELECTOR, $metadata ) );
	}
	...
	public function test_unwraps_block_style_variations() {
		...
		$input = new FP_Theme_JSON_Gutenberg(
			array(
				'version' => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'  => array(
					'variations' => array(
	...
	public function data_get_styles_for_block_with_style_variations() {
		$plain = array(
			'metadata' => array(
				...
				'selector' => '.is-style-plain.fp-block-quote',
			),
			'styles'   => ':root :where(.is-style-plain.fp-block-quote){background-color: hotpink;}',
		);
	...
	public function test_get_styles_for_block_with_style_variations_and_custom_selectors() {
		register_block_type(
			...
			array(
				...
				'selectors'   => array(
					'root'  => '.milk',
					'color' => '.fp-block-test-milk .liquid, .fp-block-test-milk:not(.spoiled), .fp-block-test-milk.in-bottle',
				),
			)
		);
		...
		$metadata = array(
			...
			'variations' => array(
				'chocolate' => array(
					...
					'selector' => '.is-style-chocolate.fp-block-test-milk',
				),
			),
		);

		$actual_styles    = $theme_json->get_styles_for_block( $metadata );
		$default_styles   = ':root :where(.fp-block-test-milk .liquid, .fp-block-test-milk:not(.spoiled), .fp-block-test-milk.in-bottle){background-color: white;}';
		$variation_styles = ':root :where(.is-style-chocolate.fp-block-test-milk .liquid,.is-style-chocolate.fp-block-test-milk:not(.spoiled),.is-style-chocolate.fp-block-test-milk.in-bottle){background-color: #35281E;}';
	...
	public function test_block_style_variations() {
		fp_set_current_user( static::$administrator_id );
		...
		$actual = FP_Theme_JSON_Gutenberg::remove_insecure_properties( $expected );
	...
	public function test_block_style_variations_with_invalid_properties() {
		...
		$actual = FP_Theme_JSON_Gutenberg::remove_insecure_properties( $partially_invalid_variation );
	...
	public function test_block_style_variations_with_invalid_inner_block_or_element_styles() {
		...
		$actual = FP_Theme_JSON_Gutenberg::remove_insecure_properties( $input );
	...
	public function test_set_spacing_sizes( $spacing_scale, $expected_output ) {
		...
		$this->assertSame( $expected_output, _fp_array_get( $theme_json->get_raw_data(), array( 'settings', 'spacing', 'spacingSizes', 'default' ) ) );
	}
	...
	public function data_update_separator_declarations() {
		return array(
			...
			'only background'                      => array(
				...
				'expected_output' => ':root :where(.fp-block-separator){background-color: blue;color: blue;}',
			),
			...
			'background and text, no border-color' => array(
				...
				'expected_output' => ':root :where(.fp-block-separator){background-color: blue;color: red;}',
			),
			...
			'only text'                            => array(
				...
				'expected_output' => ':root :where(.fp-block-separator){color: red;}',
			),
			...
			'background, text, and border-color'   => array(
				...
				'expected_output' => ':root :where(.fp-block-separator){background-color: blue;border-color: pink;color: red;}',
			),
			...
			'background, and border-color'         => array(
				...
				'expected_output' => ':root :where(.fp-block-separator){background-color: blue;border-color: pink;}',
			),
		);
	}
	...
	public function test_shadow_preset_styles() {
		...
		$expected_styles = ':root{--fp--preset--shadow--natural: 5px 5px 5px 0 black;--fp--preset--shadow--sharp: 5px 5px black;}';
	...
	public function test_get_shadow_styles_for_blocks() {
		$theme_json = new FP_Theme_JSON_Gutenberg(
			array(
				...
				'styles'   => array(
					'blocks'   => array(
						'core/paragraph' => array(
							'shadow' => 'var(--fp--preset--shadow--natural)',
						),
					),
					'elements' => array(
						'button' => array(
		...
		$variable_styles = ':root{--fp--preset--shadow--natural: 5px 5px 0 0 black;}';
		$element_styles  = 'a:where(:not(.fp-element-button)){box-shadow: var(--fp--preset--shadow--natural);}:root :where(.fp-element-button, .fp-block-button__link){box-shadow: var(--fp--preset--shadow--natural);}:root :where(p){box-shadow: var(--fp--preset--shadow--natural);}';
	...
	public function test_get_top_level_background_image_styles() {
		...
		$expected_styles = "html{min-height: calc(100% - var(--fp-admin--admin-bar--height, 0px));}body{background-image: url('http://example.org/image.png');background-position: center center;background-repeat: no-repeat;background-attachment: fixed;}";
		...
		$expected_styles = "html{min-height: calc(100% - var(--fp-admin--admin-bar--height, 0px));}body{background-image: url('http://example.org/image.png');background-position: center center;background-repeat: no-repeat;background-size: contain;background-attachment: fixed;}";
	...
	public function test_get_block_background_image_styles() {
		...
		$group_styles = ":root :where(.fp-block-group){background-image: url('http://example.org/group.png');background-position: center center;background-repeat: no-repeat;background-attachment: fixed;}";
		...
		$quote_styles = ":root :where(.fp-block-quote){background-image: url('http://example.org/quote.png');background-position: 50% 50%;background-size: contain;}";
		...
		$verse_node = array(
			...
			'selector'  => '.fp-block-verse',
			'selectors' => array(
				'root' => '.fp-block-verse',
			),
		);

		$verse_styles = ":root :where(.fp-block-verse){background-image: url('http://example.org/verse.png');background-size: cover;}";
	...
	public function test_custom_css_for_user_caps( $user_property, array $expected ) {
		fp_set_current_user( static::${$user_property} );
	...
	public function test_internal_syntax_is_converted_to_css_variables() {
		$result = new FP_Theme_JSON_Gutenberg(
			array(
				'version' => FP_Theme_JSON_Gutenberg::LATEST_SCHEMA,
				'styles'  => array(
					'color'    => array(
					...
					'elements' => array(
						'link' => array(
							'color' => array(
								...
								'text'       => 'var(--fp--preset--color--sec)',
							),
						),
					),
					'blocks'   => array(
						'core/post-terms' => array(
							'typography' => array( 'fontSize' => 'var(--fp--preset--font-size--small)' ),
							...
							'elements' => array(
								'link' => array(
									'color' => array(
										...
										'text'       => 'var(--fp--preset--color--s)',
									),
								),
							),
						),
						'core/quote'      => array(
							'typography' => array( 'fontSize' => 'var(--fp--preset--font-size--d)' ),
							'color'      => array( 'background' => 'var:preset|color|d' ),
							'variations' => array(
								'plain' => array(
									'typography' => array( 'fontSize' => 'var(--fp--preset--font-size--s)' ),
		...
		$this->assertEquals( 'var(--fp--preset--color--primary)', $styles['color']['background'], 'Top level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fp--preset--color--secondary)', $styles['color']['text'], 'Top level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fp--preset--color--pri)', $styles['elements']['link']['color']['background'], 'Element top level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fp--preset--color--sec)', $styles['elements']['link']['color']['text'], 'Element top level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fp--preset--font-size--small)', $styles['blocks']['core/post-terms']['typography']['fontSize'], 'Top block level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fp--preset--color--secondary)', $styles['blocks']['core/post-terms']['color']['background'], 'Top block level: Assert the internal variables are convert to CSS custom variables.' );

		$this->assertEquals( 'var(--fp--preset--color--p)', $styles['blocks']['core/navigation']['elements']['link']['color']['background'], 'Elements block level: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fp--preset--color--s)', $styles['blocks']['core/navigation']['elements']['link']['color']['text'], 'Elements block level: Assert the originally correct values are still correct.' );

		$this->assertEquals( 'var(--fp--preset--font-size--s)', $styles['blocks']['core/quote']['variations']['plain']['typography']['fontSize'], 'Style variations: Assert the originally correct values are still correct.' );
		$this->assertEquals( 'var(--fp--preset--color--s)', $styles['blocks']['core/quote']['variations']['plain']['color']['background'], 'Style variations: Assert the internal variables are convert to CSS custom variables.' );
	}
	 ...
	 * @ticket 58588
	 *
	 * @covers FP_Theme_JSON_Gutenberg::resolve_variables
	 * @covers FP_Theme_JSON_Gutenberg::convert_variables_to_value
	 */
	public function test_resolve_variables() {
			...
			array(
				...
				'styles'   => array(
					...
					'elements' => array(
						'button' => array(
							'color'      => array(
								'text' => 'var(--fp--preset--color--contrast)',
							),
							'typography' => array(
					...
					'blocks'   => array(
						...
						'core/more'            => array(
							...
							'color'      => array( 'background' => 'linear-gradient(90deg, var(--fp--preset--color--primary) 0%, var(--fp--preset--color--secondary) 35%, var(--fp--undefined--color--secondary) 100%)' ),
						),
						'core/comment-content' => array(
							'typography' => array( 'fontSize' => 'calc(var(--fp--preset--font-size--small, 12px) + 20px)' ),
							'color'      => array(
								'text'       => 'var(--fp--preset--color--primary, red)',
								'background' => 'var(--fp--preset--color--primary, var(--fp--preset--font-size--secondary))',
								'link'       => 'var(--undefined--color--primary, var(--fp--preset--font-size--secondary))',
							),
						),
						'core/comments'        => array(
							'color' => array(
								'text'       => 'var(--undefined--color--primary, var(--fp--preset--font-size--small))',
								'background' => 'var(--fp--preset--color--primary, var(--undefined--color--primary))',
							),
						),
						'core/navigation'      => array(
							'elements' => array(
						...
						'core/quote'           => array(
							'typography' => array( 'fontSize' => 'var(--fp--preset--font-size--large)' ),
							'color'      => array( 'background' => 'var(--fp--preset--color--primary)' ),
							'variations' => array(
								'plain' => array(
									'typography' => array( 'fontSize' => 'var(--fp--preset--font-size--small)' ),
									'color'      => array( 'background' => 'var(--fp--preset--color--secondary)' ),
								),
							),
						),
						...
						'core/columns'         => array(
							'spacing' => array(
								'blockGap' => 'var(--fp--preset--spacing--100)',
							),
						),
					),
				),
		...
		$this->assertEquals(
			"linear-gradient(90deg, $primary_color 0%, $secondary_color 35%, var(--fp--undefined--color--secondary) 100%)",
		...
		/*
		 * FP_Theme_JSON_Gutenberg::resolve_variables may be called with merged data from FP_Theme_JSON_Resolver_Gutenberg::get_merged_data()
		 * FP_Theme_JSON_Resolver_Gutenberg::get_block_data() sets blockGap for supported blocks to `null` if the value is not defined.
		 */
	...
	public function test_get_block_style_variation_selector( $selector, $expected ) {
		$theme_json = new ReflectionClass( 'FP_Theme_JSON_Gutenberg' );
	...
	public function data_get_block_style_variation_selector() {
		return array(
			...
			'comma separated selector' => array(
				...
				'expected' => '.fp-block.is-style-custom .inner, .fp-block.is-style-custom .alternative',
			),
			...
			':is selector'             => array(
				...
				'expected' => '.fp-block.is-style-custom:is(.outer .inner:first-child)',
			),
			':not selector'            => array(
				'selector' => '.fp-block:not(.outer .inner:first-child)',
				'expected' => '.fp-block.is-style-custom:not(.outer .inner:first-child)',
			),
			':has selector'            => array(
				'selector' => '.fp-block:has(.outer .inner:first-child)',
				'expected' => '.fp-block.is-style-custom:has(.outer .inner:first-child)',
			),
			':where selector'          => array(
				'selector' => '.fp-block:where(.outer .inner:first-child)',
				'expected' => '.fp-block.is-style-custom:where(.outer .inner:first-child)',
			),
			...
			'complex'                  => array(
				'selector' => '.fp:where(.something):is(.test:not(.nothing p)):has(div[style]) .content, .fp:where(.nothing):not(.test:is(.something div)):has(span[style]) .inner',
				'expected' => '.fp.is-style-custom:where(.something):is(.test:not(.nothing p)):has(div[style]) .content, .fp.is-style-custom:where(.nothing):not(.test:is(.something div)):has(span[style]) .inner',
			),
		);
	}
	...
	public function test_scope_style_node_selectors() {
		...
		$node = array(
			...
			'selectors' => array(
				...
				'border'     => '.fp-block-image img, .fp-block-image .fp-block-image__crop-area, .fp-block-image .components-placeholder',
				'typography' => array(
					'textDecoration' => '.fp-block-image caption',
				),
				'filter'     => array(
					'duotone' => '.fp-block-image img, .fp-block-image .components-placeholder',
				),
			),
		);
		...
		$expected = array(
			'name'      => 'core/image',
			'path'      => array( 'styles', 'blocks', 'core/image' ),
			'selector'  => '.custom-scope .fp-block-image',
			'selectors' => array(
				'root'       => '.custom-scope .fp-block-image',
				'border'     => '.custom-scope .fp-block-image img, .custom-scope .fp-block-image .fp-block-image__crop-area, .custom-scope .fp-block-image .components-placeholder',
				'typography' => array(
					'textDecoration' => '.custom-scope .fp-block-image caption',
				),
				'filter'     => array(
					'duotone' => '.custom-scope .fp-block-image img, .custom-scope .fp-block-image .components-placeholder',
				),
			),
		);
	...
	public function test_opt_in_to_block_style_variations() {
		...
		$expected = array(
			array(
				...
				'selector' => '.fp-block-button.is-style-outline .fp-block-button__link',
			),
		);
