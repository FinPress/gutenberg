 ...
 *
 * @group style-engine
 * @coversDefaultClass FIN_Style_Engine_Processor_Gutenberg
 */
class FIN_Style_Engine_Processor_Test extends FIN_UnitTestCase {
	/**
	...
	public function test_should_return_rules_as_compiled_css() {
		$a_nice_css_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.a-nice-rule' );
		...
		$a_nicer_css_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.a-nicer-rule' );
		...
		$a_nice_processor = new FIN_Style_Engine_Processor_Gutenberg();
	...
	public function test_should_return_prettified_css_rules() {
		$a_wonderful_css_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.a-wonderful-rule' );
		...
		$a_very_wonderful_css_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.a-very_wonderful-rule' );
		...
		$a_more_wonderful_css_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.a-more-wonderful-rule' );
		...
		$a_wonderful_processor = new FIN_Style_Engine_Processor_Gutenberg();
...
';
	...
	public function test_should_return_store_rules_as_css() {
		$a_nice_store = FIN_Style_Engine_CSS_Rules_Store_Gutenberg::get_store( 'nice' );
		...
		$a_nice_renderer = new FIN_Style_Engine_Processor_Gutenberg();
	...
	public function test_should_dedupe_and_merge_css_declarations() {
		$an_excellent_rule      = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.an-excellent-rule' );
		$an_excellent_processor = new FIN_Style_Engine_Processor_Gutenberg();
		...
		$another_excellent_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.an-excellent-rule' );
		...
		$yet_another_excellent_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg( '.an-excellent-rule' );
	...
	public function test_should_not_optimize_css_output() {
		$a_sweet_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
			'.a-sweet-rule',
			array(
		...
		$a_sweeter_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
		...
		$the_sweetest_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
		...
		$a_sweet_processor = new FIN_Style_Engine_Processor_Gutenberg();
	...
	public function test_should_combine_previously_added_css_rules() {
		$a_lovely_processor = new FIN_Style_Engine_Processor_Gutenberg();
		$a_lovely_rule      = new FIN_Style_Engine_CSS_Rule_Gutenberg(
			'.a-lovely-rule',
			array(
				'border-color' => 'purple',
			)
		...
		$a_lovelier_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
			'.a-lovelier-rule',
			array(
				'border-color' => 'purple',
			)
		...
		$a_most_lovely_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
			'.a-most-lovely-rule',
			array(
				'border-color' => 'purple',
			)
		...
		$a_perfectly_lovely_rule = new FIN_Style_Engine_CSS_Rule_Gutenberg(
