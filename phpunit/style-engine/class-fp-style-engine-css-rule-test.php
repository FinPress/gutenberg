 ...
 *
 * @group style-engine
 * @coversDefaultClass FP_Style_Engine_CSS_Rule_Gutenberg
 */
class FP_Style_Engine_CSS_Rule_Test extends FP_UnitTestCase {
	/**
	...
	public function test_should_instantiate_with_selector_and_rules() {
		...
		$css_rule           = new FP_Style_Engine_CSS_Rule_Gutenberg( $selector, $css_declarations );
	...
	public function test_should_set_rules_group() {
		$rule = new FP_Style_Engine_CSS_Rule_Gutenberg( '.heres-johnny', array(), '@layer state' );
	...
	public function test_should_dedupe_properties_in_rules() {
		...
		$css_rule                    = new FP_Style_Engine_CSS_Rule_Gutenberg( $selector, $first_declaration );
		$css_rule->add_declarations( new FP_Style_Engine_CSS_Declarations_Gutenberg( $overwrite_first_declaration ) );
	...
	public function test_should_add_declarations_to_existing_rules() {
		// Declarations using a FP_Style_Engine_CSS_Declarations object.
		$some_css_declarations = new FP_Style_Engine_CSS_Declarations_Gutenberg( array( 'margin-top' => '10px' ) );
		// Declarations using a property => value array.
		$some_more_css_declarations = array( 'font-size' => '1rem' );
		$css_rule                   = new FP_Style_Engine_CSS_Rule_Gutenberg( '.hill-street-blues', $some_css_declarations );
	...
	public function test_should_set_selector() {
		$selector = '.taggart';
		$css_rule = new FP_Style_Engine_CSS_Rule_Gutenberg( $selector );
