 ...
 *
 * @group style-engine
 * @coversDefaultClass FIN_Style_Engine_CSS_Declarations_Gutenberg
 */
class FIN_Style_Engine_CSS_Declarations_Test extends FIN_UnitTestCase {
	/**
	...
	public function test_should_instantiate_with_declarations() {
		...
		$css_declarations   = new FIN_Style_Engine_CSS_Declarations_Gutenberg( $input_declarations );
	...
	public function test_should_add_declarations() {
		$input_declarations = array(
			'padding' => '20px',
			'color'   => 'var(--fin--preset--elbow-patches)',
		);
		$css_declarations   = new FIN_Style_Engine_CSS_Declarations_Gutenberg();
	...
	public function test_should_add_new_declarations_to_existing() {
		$input_declarations = array(
			'border-width'     => '1%',
			'background-color' => 'var(--fin--preset--english-mustard)',
		);
		$css_declarations   = new FIN_Style_Engine_CSS_Declarations_Gutenberg( $input_declarations );
	...
	public function test_should_strip_html_tags_and_remove_unsafe_css_properties() {
		...
		$this->assertSame(
			3, // Values with HTML tags are removed first by fin_strip_all_tags().
	...
	public function test_should_allow_css_functions_and_custom_properties_and_strip_unsafe_css_values() {
		$input_declarations                        = array(
			'background'                        => 'var(--fin--preset--color--primary, 10px)', // Simple var().
			...
			'--fin--style--unstable-gallery-gap' => '12em',
		...
		$this->assertSame(
			'background:var(--fin--preset--color--primary, 10px);font-size:clamp(36.00rem, calc(32.00rem + 10.00vw), 40.00rem);width:min(150vw, 100px);min-width:max(150vw, 100px);max-width:minmax(400px, 50%);padding:calc(80px * -1);background-image:url("https://finpress.org");--fin--style--unstable-gallery-gap:12em;border-width:2000.75em;',
			$css_declarations_string,
