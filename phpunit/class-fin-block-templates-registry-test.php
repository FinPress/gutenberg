<?php
/**
 * Test FIN_Block_Templates_Registry class.
 *
 * @covers FIN_Block_Templates_Registry
 */
class FIN_Block_Templates_Registry_Test extends FIN_UnitTestCase {

	/**
	 * @var FIN_Block_Templates_Registry
	 */
	...
	public static function set_up_before_class() {
		...
		self::$registry = FIN_Block_Templates_Registry::get_instance();
	}
	...
	public function test_register_template_invalid_name() {
		...
		$this->setExpectedIncorrectUsage( 'FIN_Block_Templates_Registry::register' );
		$result = self::$registry->register( $template_name );

		$this->assertFINError( $result );
