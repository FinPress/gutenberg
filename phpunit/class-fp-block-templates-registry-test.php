<?php
/**
 * Test FP_Block_Templates_Registry class.
 *
 * @covers FP_Block_Templates_Registry
 */
class FP_Block_Templates_Registry_Test extends FP_UnitTestCase {

	/**
	 * @var FP_Block_Templates_Registry
	 */
	...
	public static function set_up_before_class() {
		...
		self::$registry = FP_Block_Templates_Registry::get_instance();
	}
	...
	public function test_register_template_invalid_name() {
		...
		$this->setExpectedIncorrectUsage( 'FP_Block_Templates_Registry::register' );
		$result = self::$registry->register( $template_name );

		$this->assertFPError( $result );
